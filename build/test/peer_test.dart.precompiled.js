...
v=new H.yo(0,null,!1)
u=new H.aX(x,y,w,new I(),v,P.N3(),!1,[],P.fM(null,null,null,null))
w.h(0,0)
u.aU(0,v)
...
o=new H.yo(0,null,!1)
n=new H.aX(q,y,p,new I(),o,P.N3(),!1,[],P.fM(null,null,null,null))
p.h(0,0)
n.aU(0,o)
...
gFV:function(a){if(this.gB(this)===0)throw H.b(new P.lj("No elements"))
return this.Zv(0,0)},
...
lz:{
"^":"Tp;a,b,c,d",
call$1:function(a){P.FE(new P.Jb(this.c,a),new P.fj(),P.TB(this.a.a,this.d))},
$signature:function(){return H.IG(function(a){return{func:"Lf",args:[a]}},this.b,"qh")}},
Jb:{
"^":"Tp:12;e,f",
...
$isiP:true,
static:{"^":"Oj,Vp,df,p2,ch,QC,Px,Zx,FS,Gi,Fz,cR,E0,Ke,Cg,Nr,bm,FI,Kz,ek,yf,Fk",tc:function(a){var z,y
z=Math.abs(a)
y=a<0?"-":""
if(z>=1000)return""+a
...
$isa6:true,
static:{"^":"Wt,S4,dk,Lo,zj,b2,q9,Ie,Do,Pu,MV,IJ,D9,Vk,S8,rG",ii:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"^":"Tp:21;",
...
this.r0=this.x6(c,d)},
$isiD:true,
static:{"^":"Qq,nR,tv,GE,V2,il,Nv,Gp,Q5,vl,om,pk,O5,Ic,qf,Tx,u0,TG,Te,YD,vT,WT,Hi,H5,WU,De,bf,Sp,e7,Qd,Bf,SQ,fb",hK:function(a1){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0
x=new P.hP()
w=new P.Uo(a1)
v=J.U6(a1)
u=v.gB(a1)
...
throw H.b(P.f("'Uri.base' is not supported"))},EH:function(a,b){a.aN(a,new P.In(b))},RG:function(a,b,c){J.Ld(a,c).aN(0,new P.o7(b))},GL:function(a,b){var z
...
$.PN=z}return z}}],["lazy_trace","package:stack_trace/src/lazy_trace.dart",,S,{
"^":"",
zz:{
"^":"a;Rf,Tt",
...
v=new N.TJ(z,x,null,w,H.VM(new F.A2(w),[null,null]),null)
v.QL(z,x,w)
return v}},
qV:{
"^":"a;oc>,P>",
...
$isqV:true,
static:{"^":"K9,tm,En,Lk,re,Fn,Eb,Jn,JY,wC"}},
HV:{
...
h:function(a,b){this.PW=this.PW+b
return this},
J9:function(a){a.mx(this)
return this}},
bI:{
"^":"Ge;G1>",
...
"^":"a;"},
AW:{
"^":"a;"}}],["messenger.connections","package:WebRTCMessenger/WebRTCMessenger/src/connections.dart",,T,{
"^":"",
qy:{
"^":"a;"}}],["messenger.events","package:WebRTCMessenger/WebRTCMessenger/src/events.dart",,O,{
"^":"",
Wu:{
"^":"a;"},
Wb:{
"^":"a;"}}],["messenger.peer","package:WebRTCMessenger/WebRTCMessenger/src/peer.dart",,S,{
"^":"",
qz:{
"^":"a;dA,Pn,oc>,LH,ly,Zw,rW,N5",
giO:function(a){return C.xB.giO(this.oc)},
ih:function(a,b){var z
if(a.length<1){z=$.Rl+1
$.Rl=z
z="peer"+C.jn.bu(z)}else z=a
this.oc=z
if(J.kE($.Om(),this))throw H.b(new P.lj("peer with name "+this.oc+" already exists!"))
$.RL=!0
z=N.Jx("Peer."+H.d(new H.cu(H.dJ(this),null))+"."+this.oc)
this.dA=z
z.sQG(b)
this.dA.gSZ().yI(new S.Jt())
this.ly=P.bK(null,null,!1,O.Wb)
this.Pn=P.bK(null,null,!1,O.Wu)
this.Zw=P.L5(null,null,null,J.im,T.qy)
z=J.O
this.N5=H.VM(new P.Zf(P.Dt(z)),[z])
z=J.O
this.rW=H.VM(new P.Zf(P.Dt(z)),[z])
this.dA.To("new peer: #"+C.jn.bu($.Rl)+" "+this.oc+" ")
this.LH=b
$.Om().push(this)},
static:{"^":"rw,Rl,OS",lw:function(a,b){var z=new S.qz(null,null,null,null,null,null,null,null)
z.ih(a,b)
return z}}},
Jt:{
"^":"Tp:27;",
call$1:function(a){P.JS(a.giJ()+" ("+a.QG.oc+"): "+a.G1)}}}],["path","package:path/path.dart",,B,{
"^":"",
...
No:{
"^":"Tp:14;",
call$1:function(a){return a==null?"null":"\""+H.d(a)+"\""}}}],["path.parsed_path","package:path/src/parsed_path.dart",,Q,{
"^":"",
v5:{
"^":"a;S,YK,aA,nJ,Ph",
...
k3:{
"^":"Tp:14;a",
call$1:function(a){return this.a.S.gmI()}}}],["path.path_exception","package:path/src/path_exception.dart",,E,{
"^":"",
dv:{
"^":"a;G1>",
...
if(z.gBy())z.nJ.push("")
return P.R6("",y.gFV(y),null,z.nJ,0,null,null,"file","")}else{if(z.nJ.length===0||z.gBy())z.nJ.push("")
C.Nm.aP(z.nJ,0,J.JA(z.YK,this.DF,""))
return P.R6("","",null,z.nJ,0,null,null,"file","")}}},
PA:{
"^":"Tp:14;",
call$1:function(a){return!J.xC(a,"")}}}],["stack_trace.src.utils","package:stack_trace/src/utils.dart",,N,{
"^":"",
...
y=z.gwH()
return new R.yD(H.VM(new P.Yp(y.r8(y,new N.Gj()).br(0)),[S.uA])).gek().ju(new N.XB())},
l3:{
"^":"a;"},
kw:{
"^":"i2;aK"},
...
lX:function(){return this.uY.call$0()},
...
if(z!=null)this.yf("error",z==="pass"?"Test failed after initially passing: "+a:"Test failed more than once: "+a,b)
else this.yf("fail",a,b)},
XN:[function(a,b,c){this.yf("error",b,c)},function(a,b){return this.XN(a,b,null)},"Wt","call$2","call$1","gkc",2,2,29,4],
...
XB:{
"^":"Tp:14;",
call$1:function(a){return J.xC(a.gcw(),"unittest")||a.lR.Fi==="dart"}}}],["unittest.peer","file:///Users/chris/Documents/code/messenger/test/peer_test.dart",,G,{
"^":"",
Iq:[function(){N.Gq("Peer",new G.em())},"call$0","eE",0,0,1],
em:{
"^":"Tp:12;",
call$0:function(){var z,y,x,w,v
N.nW(!0)
if(!$.eb||$.DR>0){z=$.ln().G4.length
y=N.Xn("create new peers")
x=$.Dz().gB8()
w=$.Dz()
v=w.uP
w=w.eW
$.N4().push(new N.c9(z+1,y,v,w,new G.VW(),0,"",null,null,x,null,null,!0,!1,null))}}},
VW:{
"^":"Tp:12;",
call$0:function(){S.lw("alice",C.oO)
S.lw("bob",C.oO)}}},1],["unmodifiable_collection","package:unmodifiable_collection/unmodifiable_collection.dart",,F,{
"^":"",
A2:{
"^":"a;Mw",
gB:function(a){return this.Mw.X5},
gl0:function(a){return this.Mw.X5===0},
t:function(a,b){return this.Mw.t(0,b)},
aN:function(a,b){return this.Mw.aN(0,b)},
...
$isL8:true,
static:{kT:function(){throw H.b(P.f("Cannot modify an unmodifiable Map"))}}}}],["utils","package:unittest/src/utils.dart",,N,{
"^":"",
xp:{
"^":"a;"}}],])
...
I.$lazy($,"_initialDot","zQ","NJ",function(){return new H.VR(H.v4("^\\.",!1,!0,!1),null,null)})
...
I.$lazy($,"peers","OS","Om",function(){return H.VM([],[S.qz])})
...
init.metadata=[{func:"zx",args:[J.O]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.Bp]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"zs",ret:J.O,args:[J.O]},{func:"Q9",ret:J.P,args:[J.P,J.P]},{func:"Yw",ret:J.O,args:[null,O.AW,J.O,P.L8,J.kn]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"zk",args:[J.kn]},{func:"bb",args:[null,P.Bp]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"N4",ret:J.kn,args:[J.im]},{func:"an",ret:J.im,args:[J.im]},{func:"wJ",ret:J.im,args:[null,null]},{func:"xM",void:true,args:[J.O]},{func:"BC",ret:J.im,args:[J.im,J.im]},{func:"IM",args:[N.HV]},{func:"rl",ret:P.b8},{func:"Ji",void:true,args:[J.O],opt:[P.Bp]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
xp.prototype=$desc
return[qE,Gh,rK,fY,ul,lJ,ct,nB,i3,it,QP,QW,jr,Ny,nx,QQ,fW,y4,d7,Um,oJ,He,HA,vH,dY,Em,NW,rV,Wy,QF,Ec,cm,Nh,cv,Fs,hY,pS,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,GJ,pA,Rp,XF,Xb,wP,iY,A6,Og,u8,M6,El,e2,SV,aB,fJ,BK,D8,Vh,rC,ZY,cx,Ee,Qb,PG,xe,Hw,bn,eC,Ve,Aj,oU,ih,KV,BH,mh,G7,l9,Ql,wL,bP,FH,SN,HD,ni,jg,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,QR,Cp,ua,HN,Ul,KK,bk,fq,h4,qk,GI,Tb,Iv,BT,OH,kJ,AE,xV,YS,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,hq,WS,r0,kc,c1,Df,Nf,Nc,rj,Zv,nA,yK,Dh,ZJ,mU,eZ,IT,nV,Zc,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,wj,wf,TC,bb,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,zU,rE,CC,PQ,uz,Yd,K8,AD,Gr,cs,GH,To,MU,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,ZG,UD,ZD,vt,wD,BD,vR,j8,Qr,zI,cB,LQ,o4,HP,fa,aC,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,Qe,PK,JO,O2,aX,cC,RA,IY,JH,jl,Vg,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,xZ,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,lc,v,Eq,lb,tD,i6,cu,dC,wN,VX,VR,EK,KW,Pb,tQ,aL,nH,a7,i1,xy,MH,A8,oi,SO,zs,rR,eG,Ls,Mr,yY,Fu,SU,Tv,w2,iK,Ca,Ik,JI,WV,zW,tK,DL,b8,Pf,Zf,vs,da,xw,dm,rH,rq,RW,YP,FZ,ez,OM,qh,Sd,jv,bi,YJ,lz,Jb,fj,M4,B5,PI,j4,i9,lU,OC,UH,Z5,MO,qA,ms,UO,Bc,VT,Fj,q1,Zz,ly,MF,O9,yU,nP,KA,qB,aN,fI,LV,dp,B3,CR,Qk,dR,uR,QX,fZ,TF,K5,pK,eM,R8,k6,NB,fG,EQ,YB,a1,db,i5,N6,Ta,YO,oz,b6,tj,mF,Yp,u3,mW,ar,lD,ZQ,Sw,o0,Uk,zF,Zi,z0,E3,Rw,GY,jZ,CL,iP,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,aE,kM,An,L8,c8,a,Od,Bp,Rn,wv,iD,hP,Uo,In,o7,hb,Kd,yZ,Gs,tS,Tw,wm,FB,cn,G1,Mx,C9,VC,tp,d9,rI,BV,E1,zL,ec,Gm,W9,rB,IU,b0,CB,Ob,GV,uA,zz,TJ,dG,qV,HV,nF,bI,wJ,i2,nv,AW,qy,Wu,Wb,qz,Jt,lI,Mi,q7,Qt,No,v5,k3,dv,OO,OF,ru,IV,PA,yD,NM,oA,zo,HC,hi,xQ,dg,un,Gt,AH,lO,ut,mu,l3,kw,Is,c9,Sg,UB,Rm,Ct,We,q4,nJ,ZA,Z7,hJ,k5,Gj,XB,em,VW,A2,xp]}