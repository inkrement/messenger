...
return this.zO}}}],["compact_vm_config","package:unittest/compact_vm_config.dart",,S,{
"^":"",
Es:function(){var z,y
if(J.xC(P.Xf().uv.t(0,"LOGNAME"),"chrome-bot"))return
z=$.u9()
y=$.Eu
if(y==null?z!=null:y!==z){if(y!=null)H.vh(new P.lj("unittestConfiguration has already been set"))
$.Eu=z}},
M0:{
"^":"Vo;iy,Tg,hW,Ta,lV,mq,IT,rM,Yx,uW,qd,Nc,Lw,KV,dm,Va",
mB:function(){this.iy=P.at()},
Aw:function(){var z=new P.iP(Date.now(),!1)
z.EK()
this.Tg=z},
ah:function(a){N.Is.prototype.ah.call(this,a)
this.t0(this.Tg,this.hW,this.Ta,a.N0)},
RO:function(a){var z,y
N.Is.prototype.RO.call(this,a)
z=a.N0
if(a.C7==="pass"){y=this.hW+1
this.hW=y
this.t0(this.Tg,y,this.Ta,z)}else{y=this.Ta+1
this.Ta=y
this.t0(this.Tg,this.hW,y,z)
P.JS("")
if(!J.xC(a.dW,""))P.JS(J.JA(a.dW,new H.VR(H.v4("^",!0,!0,!1),null,null),"  "))
z=a.qn
if(z!=null)P.JS(J.JA(J.AG(z),new H.VR(H.v4("^",!0,!0,!1),null,null),"  "))}},
pE:function(a){P.pH([P.cr().xO(),P.XW().xO()],!1).ml(new S.O3(this,a))},
WO:function(a,b,c,d,e){var z,y,x,w
if(a===0&&b===0&&c===0&&!0)P.JS("\nNo tests ran.")
else{z=b===0&&c===0&&!0
y=this.Tg
x=this.hW
w=this.Ta
if(z){this.V7(y,x,w,"All tests passed!","\u001b[0m")
P.JS("")}else{this.V7(y,x,w,"Some tests failed.","\u001b[31m")
P.JS("")
P.JS(""+a+" PASSED, "+b+" FAILED, "+c+" ERRORS")}}},
V7:function(a,b,c,d,e){var z,y,x,w,v,u,t,s
z=new P.iP(Date.now(),!1)
z.EK()
y=z.E8(a)
x=P.p9("")
z=y.Fq
w=C.CD.cU(z,60000000)
v=C.CD.Y(C.CD.cU(z,1000000),60)
x.KF("\r"+(this.nM(w)+":"+this.nM(v))+" ")
x.KF("\u001b[32m")
x.KF("+")
x.KF(b)
x.KF("\u001b[0m")
...
x.KF(e)
z=z?9:0
u=this.mq+e.length+z
x.KF(this.j5(d,80-(x.vM.length-u)))
x.KF("\u001b[0m")
z=x.vM
t=z.length-u-4
s=this.lV
...
x.vM=z;--s
this.lV=s}P.cr().KF(x.vM)},
t0:function(a,b,c,d){return this.V7(a,b,c,d,"\u001b[0m")},
nM:function(a){var z
if(a===0)z="00"
else z=a<10?"0"+H.d(a):H.d(a)
return z},
...
v+=1+w}while(v<=b&&x>0)
if(v>b||x===0)++x
if(x<y.length-4){u=P.p9("")
u.KF(C.Nm.gtH(y))
u.KF(" ...")
for(;x<y.length;++x){u.vM=u.vM+" "
t=y[x]
t=typeof t==="string"?t:H.d(t)
u.vM=u.vM+t}return u.vM}}s=C.xB.yn(a,z-b+4)
r=C.xB.u8(s," ")
return"..."+(r>0?C.xB.yn(s,r):s)}},
O3:{
"^":"Tp:14;a,b",
call$1:function(a){var z=this.a.iy
z.vl.xO()
z.da.xO()
P.zP(this.b?0:1)},
...
z.e=null
y=new P.VN(z,b)
for(x=H.VM(new H.a7(a,2,0,null),[H.Kp(a,0)]);x.G();){w=x.lo
v=z.c
z.c=v+1
...
OH:function(a){var z=J.x(a)
z=typeof a==="object"&&a!==null&&!!z.$isaS
if(z);if(z)z=a.Gv<4
else z=!1
if(z){this.rX(a)
...
u=typeof y==="object"&&y!==null&&!!u.$isaS
...
v.b=!1}w=z.a
v=J.x(w)
if(typeof w==="object"&&w!==null&&!!v.$isaS){w=this.Rm
w.swG(!0)
this.b.d=!0
...
if((z&1)!==0)this.Iv(b)
else if((z&3)===0)this.kW().h(0,H.VM(new P.LV(b,null),[H.W8(this,"ms",0)]))},"call$1","ght",2,0,function(){return H.IG(function(a){return{func:"lU",void:true,args:[a]}},this.$receiver,"ms")}],
xO:function(){var z,y
z=this.Gv
...
lD:{
"^":"a;",
gA:function(a){return H.VM(new H.a7(this,this.gB(this),0,null),[H.W8(this,"lD",0)])},
...
r8:function(a,b){return H.VM(new H.eG(this,b),[H.W8(this,"lD",0)])},
...
$isiP:true,
static:{"^":"Oj,Vp,df,p2,ch,QC,Px,YR,kc,Gi,Fz,cR,E0,Ke,Cg,Nr,bm,o4,Kz,ek,yf,Fk",Gq:function(a){var z,y
z=Math.abs(a)
y=a<0?"-":""
if(z>=1000)return""+a
...
this.r0=this.x6(c,d)},
$isiD:true,
static:{"^":"Qq,nR,tv,uC,V2,il,Nv,Gp,Q5,Xr,om,pk,O5,Fs,qf,Tx,u0,TG,Te,YD,Vh,WT,Hi,H5,WU,VF,bf,Sp,e7,Qd,Bf,E7,fb",hK:function(a1){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0
x=new P.hP()
w=new P.Uo(a1)
v=J.dD(a1)
u=v.gB(a1)
...
return P.F(s,!0,H.W8(s,"mW",0))},jW:function(a,b,c,d){var z,y,x,w,v,u,t,s,r
z=new P.rI()
y=P.p9("")
x=c.gZE().WJ(b)
...
$isEH:true}}],["dart.io","dart:io",,P,{
"^":"",
qR:function(a){var z
if(a.length===0)a="."
$.tX()
for(;z=$.Gm(),!C.xB.Tc(a,z);)a+=H.d(z)
return a},
b8:function(){throw H.b(P.f("Platform._pathSeparator"))},
DW:function(){throw H.b(P.f("Platform._operatingSystem"))},
D8:function(){throw H.b(P.f("Platform._environment"))},
Lj:function(){return P.b8()},
RB:function(){return P.DW()},
Xf:function(){var z=$.mf
if(z==null)P.D8()
return z},
wC:function(a){throw H.b(P.f("ProcessUtils._exit"))},
zP:function(a){if(typeof a!=="number"||Math.floor(a)!==a)throw H.b(new P.AT("Integer value for exit code expected"))
P.wC(a)},
cr:function(){$.hp=P.M7(1)
return $.hp},
XW:function(){$.l5=P.M7(2)
return $.l5},
ed:function(a){if(J.xC(a,P.cr())||J.xC(a,P.XW()))switch(P.Tm(J.xC(a,P.cr())?1:2)){case 0:return C.G5
case 1:return C.ai
case 2:return C.Bj
default:}return C.DH},
M7:function(a){throw H.b(P.f("StdIOUtils._getStdioOutputStream"))},
Tm:function(a){throw H.b(P.f("StdIOUtils._getStdioHandleType"))},
Mn:{
"^":"xG;Ii",
Cw:function(a,b){return P.GQ(P.qR(this.Ii),b,a)},
BY:function(a){return this.Cw(!0,a)},
bu:function(a){return"Directory: '"+this.Ii+"'"},
static:{GQ:function(a,b,c){throw H.b(P.f("Directory._list"))}}},
xG:{
"^":"a;"},
uv:{
"^":"a;oc",
bu:function(a){return"StdioType: "+this.oc},
static:{"^":"et,zu,Yh,WP"}}}],["dart.isolate","dart:isolate",,P,{
"^":"",
...
z=P.p9("")
for(y=H.VM(new H.oi(a,new F.q7()),[H.W8(a,"mW",0)]),y=H.VM(new H.SO(J.de(y.l6),y.T6),[H.Kp(y,0)]),x=this.S,w=y.OI,v=!1,u=!1;y.G();){t=w.gl()
...
y=H.K1(y,new A.Fu(a,z),H.W8(y,"mW",0),null)
...
$isEH:true}}],["","file:///Users/chris/Documents/code/messenger/test/selftest_test.dart",,R,{
"^":"",
Iq:[function(){var z,y,x,w,v
S.Es()
N.nW(!0)
if(!$.eb||$.DR>0){z=$.ln().G4.length
y=N.Xn("max 80 chars per line")
x=$.Dz().gB8()
w=$.Dz()
v=w.uP
w=w.eW
$.N4().push(new N.c9(z+1,y,v,w,new R.em(),0,"",null,null,x,null,null,!0,!1,null))}},"call$0","eE",0,0,12],
em:{
"^":"Tp:12;",
call$0:function(){new P.Mn("../lib").BY(!0)},
$isEH:true}},1],["stack_trace.src.utils","package:stack_trace/src/utils.dart",,N,{
"^":"",
...
try{if(J.CF(a)===!0){y=H.VM(new P.Yp(C.Nm.br(H.VM([],[S.uA]))),[S.uA])
...
return new R.yD(H.VM(new P.Yp(H.K1(z,new R.HC(),H.W8(z,"mW",0),null).br(0)),[S.uA]))},Qz:function(a){return new R.yD(H.VM(new P.Yp(H.VM(new H.A8(J.Q7(a).split("\n"),new R.hi()),[null,null]).br(0)),[S.uA]))},Xk:function(a){var z=H.VM(new H.oi(J.Q7(a).split("\n"),new R.xQ()),[null])
...
ah:function(a){C.Nm.sB(this.dm,0)},
RO:function(a){var z,y,x,w,v,u,t,s
if(!this.KV&&this.dm.length>0){z=P.p9("")
for(y=this.dm,x=H.j5(y,0,y.length-1,null),x=H.VM(new H.a7(x,x.gB(x),0,null),[H.W8(x,"aL",0)]);x.G();){w=x.lo
v=J.lG(w)
u=v.gtH(w)
u=typeof u==="string"?u:H.d(u)
t=z.vM+u
...
y+="\n"
z.vM=y
if(!J.xC(a.dW,"")){x=J.JA(a.dW,new H.VR(H.v4("^",!0,!0,!1),null,null),"  ")
y+=x
z.vM=y
y+="\n"
z.vM=y}x=a.qn
if(x!=null){x=J.JA(J.AG(x),new H.VR(H.v4("^",!0,!0,!1),null,null),"  ")
y+=x
z.vM=y
y+="\n"
z.vM=y}return y},
WO:function(a,b,c,d,e){var z,y
for(z=d.gA(d);z.G();){y=C.xB.bS(this.fQ(z.lo))
H.qw(y)}P.JS("")
...
this.C7=null
this.dW=""
return P.Ab(null,null).ml(new N.UB(this)).OA(this.vH("Setup")).ml(new N.Ct(this)).OA(this.vH("Test")).ml(new N.eV(this)).OA(this.vH("Teardown"))},"call$0","gAk",0,0,29],
yf:function(a,b,c){var z,y
if(this.xc==null)if(this.iG!=null){z=new P.iP(Date.now(),!1)
z.EK()
this.xc=z.E8(this.iG)}else this.xc=C.RT
this.dW=b
z=N.Mb(c)
this.qn=z
if(z==null)this.qn=c
...
$isEH:true}}],["unittest_vm_config","package:unittest/vm_config.dart",,G,{
"^":"",
Vo:{
"^":"Is;",
fQ:function(a){var z,y
z=N.Is.prototype.fQ.call(this,a)
if(this.qd===!0)if(a.gyG()==="pass")return this.IT+z+this.uW
else{y=a.C7
if(y==="fail")return this.rM+z+this.uW
else if(y==="error")return this.Yx+z+this.uW}return z},
mB:function(){N.Is.prototype.mB.call(this)
$.eP=!0
$.iR=!0},
pE:function(a){var z,y
z={}
z.a=null
try{N.Is.prototype.pE.call(this,a)
z.a=0}catch(y){H.Ru(y)
z.a=1}P.pH([P.cr().xO(),P.XW().xO()],!1).ml(new G.rs(z))}},
rs:{
"^":"Tp:14;a",
call$1:function(a){P.zP(this.a.a)},
$isEH:true}}],["utils","package:unittest/src/utils.dart",,N,{
"^":"",
...
I.$lazy($,"_singleton","o9","u9",function(){var z=H.VM([],[[N.xp,J.O,P.Bp]])
z=new S.M0(null,null,0,0,0,10,"\u001b[32m","\u001b[31m","\u001b[35m","\u001b[0m",P.ed(P.cr())===C.G5,null,!0,!0,z,C.FL)
if($.JU==null)$.JU=O.pR()
O.mv(new N.kw(z))
return z})
...
I.$lazy($,"_pathSeparator","d7","Gm",function(){return P.Lj()})
I.$lazy($,"_operatingSystem","zl","tX",function(){return P.RB()})
...
init.metadata=[{func:"zx",args:[J.O]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.Bp]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"zs",ret:J.O,args:[J.O]},{func:"Q9",ret:J.P,args:[J.P,J.P]},{func:"Yw",ret:J.O,args:[null,O.FD,J.O,P.Z0,J.kn]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"rf",args:[P.a]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"zk",args:[J.kn]},{func:"bb",args:[null,P.Bp]},{func:"jQ",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"N4",ret:J.kn,args:[J.im]},{func:"an",ret:J.im,args:[J.im]},{func:"wJ",ret:J.im,args:[null,null]},{func:"xM",void:true,args:[J.O]},{func:"BC",ret:J.im,args:[J.im,J.im]},{func:"C1",ret:J.O,args:[null,J.im,P.xu,J.kn]},{func:"RJ",ret:J.O,args:[null]},{func:"rl",ret:P.aS},{func:"Ji",void:true,args:[J.O],opt:[P.Bp]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
tQ.prototype=$desc
function M0(iy,Tg,hW,Ta,lV,mq,IT,rM,Yx,uW,qd,Nc,Lw,KV,dm,Va){this.iy=iy
this.Tg=Tg
this.hW=hW
this.Ta=Ta
this.lV=lV
...
this.KV=KV
this.dm=dm
this.Va=Va}M0.builtin$cls="M0"
if(!"name" in M0)M0.name="M0"
$desc=$collectedClasses.M0
if($desc instanceof Array)$desc=$desc[1]
M0.prototype=$desc
function O3(a,b){this.a=a
this.b=b}O3.builtin$cls="O3"
...
if($desc instanceof Array)$desc=$desc[1]
rI.prototype=$desc
function Mn(Ii){this.Ii=Ii}Mn.builtin$cls="Mn"
...
if($desc instanceof Array)$desc=$desc[1]
xG.prototype=$desc
function uv(oc){this.oc=oc}uv.builtin$cls="uv"
if(!"name" in uv)uv.name="uv"
$desc=$collectedClasses.uv
if($desc instanceof Array)$desc=$desc[1]
uv.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
l3.prototype=$desc
function kw(aK){this.aK=aK}kw.builtin$cls="kw"
if(!"name" in kw)kw.name="kw"
$desc=$collectedClasses.kw
if($desc instanceof Array)$desc=$desc[1]
kw.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
xp.prototype=$desc
return[FK,vB,kn,YE,Ue,iC,kd,Q,P,im,VA,O,Qe,PK,JO,O2,aX,cC,RA,IY,JH,jl,Vg,Iy,JM,Ua,ns,yo,fc,NA,NO,II,fP,X1,HU,oo,OW,jP,iY,yH,FA,Av,ku,IN,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,lc,v,Eq,lb,tD,i6,cu,VR,EK,KW,Pb,tQ,M0,O3,aL,nH,a7,i1,xy,MH,A8,oi,SO,zs,rR,eG,fM,Mr,yY,SJ,Qr,w2,iK,Ca,aS,VN,ff,fT,Zf,vs,da,xw,dm,rH,ZL,rq,RW,YP,FZ,ez,OM,qh,Sd,jv,i4,YJ,lz,Rl,Jb,M4,B5,PI,j4,i9,lU,OC,UH,Z5,MO,qA,ms,UO,Bc,VT,Fj,q1,Zz,ly,MF,u8,yU,nP,KA,qB,aN,fI,LV,dp,B3,CR,Qk,dR,uR,QX,fZ,TF,K5,pK,eM,R8,k6,NB,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,Yp,u3,mW,ar,lD,ZQ,Sw,o0,Uk,zF,Zi,u5,E3,Rw,GY,jZ,CL,iP,a6,P7,e8,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,aE,kM,An,Z0,c8,a,Od,xu,Bp,Rn,wv,iD,hP,Uo,In,XQ,hb,Kd,yZ,Gs,tS,Tw,wm,FB,cn,ud,hQ,C9,VC,tp,d9,rI,Mn,xG,uv,IU,uA,zz,nF,bI,wJ,i2,nv,FD,lI,Mi,q7,Qt,No,v5,k3,dv,OO,OF,ru,IV,PA,X2,UI,nu,Fu,lV,em,yD,NM,oA,zo,HC,hi,xQ,dg,un,Gt,AH,lO,ut,mu,l3,kw,Is,c9,Sg,UB,Ct,eV,We,q4,nJ,ZA,Z7,hJ,k5,XB,vN,Vo,rs,xp]}