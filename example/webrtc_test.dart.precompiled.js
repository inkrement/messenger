...
["dart.async", "dart:async", , P, {
  ...
  _BroadcastStreamController: {
    ...
    _subscribe$1: function(cancelOnError) {
      ...
      if ((this._state & 4) !== 0) {
        t1 = H.buildFunctionType(H.getVoidRuntimeType());
        t1._assertCheck$1(P._nullDoneHandler$closure());
        t2 = new P._DoneStreamSubscription($.Zone__current, 0, t1._assertCheck$1(P._nullDoneHandler$closure()));
        t2.$builtinTypeInfo = this.$builtinTypeInfo;
        t1._assertCheck$1(P._nullDoneHandler$closure());
        t2._schedule$0();
      ...
      subscription = new P._BroadcastSubscription(null, null, null, H.assertSubtype(this, "$is_StreamControllerLifecycle", [t1], "$as_StreamControllerLifecycle"), H.buildFunctionType(t4, [H.convertRtiToRuntimeType(t1)])._assertCheck$1(null), null, H.buildFunctionType(t4)._assertCheck$1(null), t2, t3, null, null);
  ...
  _Future: {
    ...
    catchError$2$test: function(onError, test) {
      ...
      t1 = H.getDynamicRuntimeType();
      t2 = H.buildFunctionType(H.buildInterfaceType(P.bool), [t1]);
      t3 = t2._assertCheck$1(test);
      ...
      t6._assertCheck$1(t3);
      t3 = t6._assertCheck$1(t6._assertCheck$1(t3));
      result = H.setRuntimeTypeInfo(new P._Future(0, t4, null, null, t6._assertCheck$1(null), t2._assertCheck$1(t3), t5, H.buildFunctionType(t1)._assertCheck$1(null)), [null]);
      this._addListener$1(result);
      return result;
    },
  ...
  _BufferingStreamSubscription: {
    ...
    onError$1: function(_, handleError) {
      if (handleError == null)
        handleError = H.interceptedTypeCheck(P._nullErrorHandler$closure(), "$isFunction");
  ...
  _DoneStreamSubscription: {
    ...
    onData$1: function(handleData) {
      H.buildFunctionType(H.getVoidRuntimeType(), [this.$tv_T()])._assertCheck$1(handleData);
    },
    onError$1: function(_, handleError) {
    },
    onDone$1: function(handleDone) {
      this._onDone = H.buildFunctionType(H.getVoidRuntimeType())._assertCheck$1(handleDone);
    },
    cancel$0: function() {
      return;
    },
...
["dart.collection", "dart:collection", , P, {
  ...
  IterableBase: {
    ...
    get$first: function(_) {
      ...
      return H.assertSubtypeOfRuntimeType(it.get$current(), H.getRuntimeTypeArgument(this, "IterableBase", 0));
    },
...
["dart.dom.html", "dart:html", , W, {
  ...
  RtcSessionDescription_RtcSessionDescription: function(dictionary) {
    var t1 = H.boolConversionCheck(P.Device_isFirefox()) ? H.S(P.Device_propertyPrefix()) + "RTCSessionDescription" : "RTCSessionDescription";
  ...
  Event: {
    "^": "Interceptor;type=",
    $isEvent: true,
    "%": "AudioProcessingEvent|AutocompleteErrorEvent|BeforeLoadEvent|BeforeUnloadEvent|CSSFontFaceLoadEvent|CloseEvent|CompositionEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|DragEvent|FocusEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|InstallPhaseEvent|KeyboardEvent|MIDIConnectionEvent|MIDIMessageEvent|MSPointerEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaStreamEvent|MediaStreamTrackEvent|MouseEvent|MouseScrollEvent|MouseWheelEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PointerEvent|PopStateEvent|ProgressEvent|RTCDTMFToneChangeEvent|ResourceProgressEvent|SVGZoomEvent|SecurityPolicyViolationEvent|SpeechInputEvent|SpeechRecognitionEvent|SpeechSynthesisEvent|StorageEvent|TextEvent|TouchEvent|TrackEvent|TransitionEvent|UIEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent|WheelEvent|XMLHttpRequestProgressEvent;Event"
  },
  EventTarget: {
    "^": "Interceptor;",
  ...
  RtcDataChannelEvent: {
    "^": "Event;",
    $isRtcDataChannelEvent: true,
    "%": "RTCDataChannelEvent"
  },
  RtcIceCandidate: {
    "^": "Interceptor;candidate=,sdpMLineIndex=,sdpMid=",
    $isRtcIceCandidate: true,
    "%": "RTCIceCandidate|mozRTCIceCandidate"
  },
  RtcIceCandidateEvent: {
    "^": "Event;candidate=",
    $isRtcIceCandidateEvent: true,
    "%": "RTCIceCandidateEvent"
  },
  RtcPeerConnection: {
    "^": "EventTarget;",
    createOffer$1: function(receiver, mediaConstraints) {
      ...
      return H.assertSubtype(completer.future, "$isFuture", [W.RtcSessionDescription], "$asFuture");
    },
    ...
    addIceCandidate$3: function(receiver, candidate, successCallback, failureCallback) {
      var t1, t2;
      t1 = H.getVoidRuntimeType();
      t2 = H.buildFunctionType(t1)._assertCheck$1(successCallback);
      t1 = H.buildFunctionType(t1, [H.buildInterfaceType(P.String)])._assertCheck$1(failureCallback);
      return receiver.addIceCandidate(candidate, H.convertDartClosureToJS(t2, 0), H.convertDartClosureToJS(t1, 1));
    },
    _createAnswer$3: function(receiver, successCallback, failureCallback, mediaConstraints) {
      var t1, t2;
      t1 = H.getVoidRuntimeType();
      t2 = H.buildFunctionType(t1, [H.buildInterfaceType(W.RtcSessionDescription)])._assertCheck$1(successCallback);
      t1 = H.buildFunctionType(t1, [H.buildInterfaceType(P.String)])._assertCheck$1(failureCallback);
      this._createAnswer_2$2(receiver, t2, t1);
      return;
    },
    _createAnswer_2$2: function(receiver, successCallback, failureCallback) {
      ...
      t2 = H.buildFunctionType(t1, [H.buildInterfaceType(W.RtcSessionDescription)])._assertCheck$1(successCallback);
      t1 = H.buildFunctionType(t1, [H.buildInterfaceType(P.String)])._assertCheck$1(failureCallback);
      return receiver.createAnswer(H.convertDartClosureToJS(t2, 1), H.convertDartClosureToJS(t1, 1));
    },
    createDataChannel$2: function(receiver, label, options) {
      return this._createDataChannel_1$2(receiver, label, P.convertDartToNative_Dictionary(options));
    },
    ...
    _createOffer$3: function(receiver, successCallback, failureCallback, mediaConstraints) {
      ...
      t2 = H.buildFunctionType(t1, [H.buildInterfaceType(W.RtcSessionDescription)])._assertCheck$1(successCallback);
      t1 = H.buildFunctionType(t1, [H.buildInterfaceType(P.String)])._assertCheck$1(failureCallback);
      this._createOffer_2$2(receiver, t2, t1);
      return;
    },
    _createOffer_2$2: function(receiver, successCallback, failureCallback) {
      ...
      t2 = H.buildFunctionType(t1, [H.buildInterfaceType(W.RtcSessionDescription)])._assertCheck$1(successCallback);
      t1 = H.buildFunctionType(t1, [H.buildInterfaceType(P.String)])._assertCheck$1(failureCallback);
      return receiver.createOffer(H.convertDartClosureToJS(t2, 1), H.convertDartClosureToJS(t1, 1));
    },
    _setLocalDescription$3: function(receiver, description, successCallback, failureCallback) {
      ...
      t2 = H.buildFunctionType(t1)._assertCheck$1(successCallback);
      t1 = H.buildFunctionType(t1, [H.buildInterfaceType(P.String)])._assertCheck$1(failureCallback);
      return receiver.setLocalDescription(description, H.convertDartClosureToJS(t2, 0), H.convertDartClosureToJS(t1, 1));
    },
    setLocalDescription$1: function(receiver, description) {
      var completer;
      H.interceptedTypeCheck(description, "$isRtcSessionDescription");
    ...
    _setRemoteDescription$3: function(receiver, description, successCallback, failureCallback) {
      ...
      t2 = H.buildFunctionType(t1)._assertCheck$1(successCallback);
      t1 = H.buildFunctionType(t1, [H.buildInterfaceType(P.String)])._assertCheck$1(failureCallback);
      return receiver.setRemoteDescription(description, H.convertDartClosureToJS(t2, 0), H.convertDartClosureToJS(t1, 1));
    },
...
["html_common", "dart:html_common", , P, {
  ...
  _convertDartToNative_PrepareForStructuredClone_findSlot: {
    ...
    call$1: function(value) {
      ...
      C.JSArray_methods.add$1(this.copies_2, null);
      return $length;
    },
    $isFunction: true
  },
...
["logging", "package:logging/logging.dart", , N, {
  ...
  Logger: {
    ...
    set$_controller: function(_controller) {
      this._controller = H.assertSubtype(_controller, "$isStreamController", [N.LogRecord], "$asStreamController");
    },
    ...
    _getStream$0: function() {
      ...
      if ($.hierarchicalLoggingEnabled || this.parent == null) {
        if (this._controller == null)
          this.set$_controller(P.StreamController_StreamController$broadcast(null, null, true, N.LogRecord));
        t1 = this._controller;
        t1.toString;
  ...
  Logger_Logger_closure: {
    ...
    call$0: function() {
      ...
      t2 = H.setRuntimeTypeInfo(new F.UnmodifiableMapView(H.assertSubtype(t1, "$isMap", [null, null], "$asMap")), [null, null]);
...
["messenger.connections", "package:WebRTCMessenger/WebRTCMessenger/src/connections.dart", , T, {
  "^": "",
  Connection: {
    "^": "Object;",
    _setCommunicationState$1: function(readyState) {
      ...
      if (this.readyState === readyState)
        return;
      H.voidTypeCheck($.get$Connection__log().log$4(C.Level_FINE_500, "change state: " + readyState.name, null, null));
      this.readyState = readyState;
      t1 = this._CSStreamController;
      H.assertSubtypeOfRuntimeType(readyState, H.getTypeArgumentByIndex(t1, 0));
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
    ...
    send$1: function(_, msg) {
      var t1;
      H.interceptedTypeCheck(msg, "$isMessage");
      H.voidTypeCheck($.get$Connection__log().log$4(C.Level_FINE_500, "new message added to buffer", null, null));
      t1 = this._sendController;
      H.assertSubtypeOfRuntimeType(msg, H.getRuntimeTypeArgument(t1, "_StreamController", 0));
      if (t1._state >= 4)
  ...
  WebRtcDataChannel: {
    ...
    gotSignalingMessage$1: [function(mevent) {
      ...
      t1 = H.interceptedTypeCheck(mevent, "$isNewMessageEvent").data;
      switch (t1._mtype) {
        case C.MessageType_ICE_CANDIDATE_5:
          H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_FINEST_300, "got ice candidate", null, null));
          t1 = C.JsonCodec_null_null.decode$1(J.toString$0(t1));
          H.interceptedTypeCheck(t1, "$isMap");
          t2 = H.boolConversionCheck(P.Device_isFirefox()) ? H.S(P.Device_propertyPrefix()) + "RTCIceCandidate" : "RTCIceCandidate";
        ...
        case C.MessageType_WEBRTC_OFFER_6:
          H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_FINE_500, "received sdp offer", null, null));
          sdp = W.RtcSessionDescription_RtcSessionDescription(H.interceptedTypeCheck(C.JsonCodec_null_null.decode$1(J.toString$0(t1)), "$isMap"));
        ...
        case C.MessageType_WEBRTC_ANSWER_7:
          H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_FINE_500, "received sdp answer", null, null));
          sdp = W.RtcSessionDescription_RtcSessionDescription(H.interceptedTypeCheck(C.JsonCodec_null_null.decode$1(J.toString$0(t1)), "$isMap"));
          ...
          break;
        default:
          H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_INFO_800, "New undefined signaling channel message", null, null));
          break;
      }
    }, "call$1", "get$gotSignalingMessage", 2, 0, 23],
    ...
    listen$0: function() {
      var t1, t2, t3;
      H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_FINEST_300, "start listening", null, null));
      t1 = this._sc.newMessageController;
      t2 = H.getTypeArgumentByIndex(t1, 0);
      H.assertSubtype(H.setRuntimeTypeInfo(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle")), [t2]), "$isStream", [H.getTypeArgumentByIndex(t1, 0)], "$asStream").listen$1(this.get$gotSignalingMessage());
      t1 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new W._EventStream(this._rpc, C.EventStreamProvider_icecandidate._eventType, false), [null]), "$isStream", [H.getTypeArgumentByIndex(C.EventStreamProvider_icecandidate, 0)], "$asStream"), "$isStream", [W.RtcIceCandidateEvent], "$asStream");
      t2 = new T.WebRtcDataChannel_listen_closure(this);
      t3 = H.getVoidRuntimeType();
      ...
      return H.assertSubtype(this._listen_completer.future, "$isFuture", [P.$int], "$asFuture");
    },
    connect$0: function() {
      var e, t1, t2, t3, t4, exception;
      t1 = $.get$WebRtcDataChannel__log();
      H.voidTypeCheck(t1.log$4(C.Level_FINEST_300, "try to connect", null, null));
      this.listen$0();
      try {
        this._dc = C.RtcPeerConnection_methods.createDataChannel$2(this._rpc, "sendDataChannel", this._dcOptions);
        H.voidTypeCheck(t1.log$4(C.Level_FINEST_300, "created new data channel", null, null));
        t1 = this._dc;
        t1.toString;
        ...
        t2 = new T.WebRtcDataChannel_connect_closure(this);
        t3 = H.getVoidRuntimeType();
        H.buildFunctionType(t3, [t1.$tv_T()])._assertCheck$1(t2);
        ...
        t1 = this._dc;
        t1.toString;
        t1 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new W._EventStream(t1, C.EventStreamProvider_close._eventType, false), [null]), "$isStream", [H.getTypeArgumentByIndex(C.EventStreamProvider_close, 0)], "$asStream"), "$isStream", [W.Event], "$asStream");
        t2 = new T.WebRtcDataChannel_connect_closure0(this);
        H.buildFunctionType(t3, [t1.$tv_T()])._assertCheck$1(t2);
        t4._assertCheck$1(null);
        t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(t2), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
        t2._tryResume$0();
        ...
        t2 = new T.WebRtcDataChannel_connect_closure1(this);
        H.buildFunctionType(t3, [t1.$tv_T()])._assertCheck$1(t2);
        t4._assertCheck$1(null);
        t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(t2), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
        t2._tryResume$0();
      ...
      return H.assertSubtype(this._connection_completer.future, "$isFuture", [P.$int], "$asFuture");
    },
    _init_send_worker$0: function() {
      ...
      var t1 = this._sendController;
      H.assertSubtype(t1, "$is_StreamControllerLifecycle", [null], "$as_StreamControllerLifecycle");
      H.assertSubtype(H.setRuntimeTypeInfo(new P._ControllerStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [null], "$as_StreamControllerLifecycle")), [null]), "$isStream", [H.getRuntimeTypeArgument(t1, "_StreamController", 0)], "$asStream").listen$1(new T.WebRtcDataChannel__init_send_worker_closure(this));
    },
    WebRtcDataChannel$1: function(sc) {
      var t1, t2, t3;
      H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_FINEST_300, "created PeerConnection", null, null));
      t1 = W.RtcPeerConnection_RtcPeerConnection(this.iceServers, null);
      this._rpc = t1;
      t1 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new W._EventStream(t1, C.EventStreamProvider_datachannel._eventType, false), [null]), "$isStream", [H.getTypeArgumentByIndex(C.EventStreamProvider_datachannel, 0)], "$asStream"), "$isStream", [W.RtcDataChannelEvent], "$asStream");
      t2 = new T.WebRtcDataChannel_closure(this, sc);
      t3 = H.getVoidRuntimeType();
      H.buildFunctionType(t3, [t1.$tv_T()])._assertCheck$1(t2);
      H.buildFunctionType(t3)._assertCheck$1(null);
      t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(t2), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
    ...
    static: {"^": "WebRtcDataChannel__log", WebRtcDataChannel$: function(sc) {
        ...
        t5 = P.$int;
        t5 = H.assertSubtype(H.setRuntimeTypeInfo(new P._AsyncCompleter(H.assertSubtype(P._Future$(t5), "$is_Future", [t5], "$as_Future")), [t5]), "$isCompleter", [t5], "$asCompleter");
        t6 = P.$int;
        t6 = H.assertSubtype(H.setRuntimeTypeInfo(new P._AsyncCompleter(H.assertSubtype(P._Future$(t6), "$is_Future", [t6], "$as_Future")), [t6]), "$isCompleter", [t6], "$asCompleter");
        t7 = P.StreamController_StreamController(null, null, null, null, false, O.NewMessageEvent);
        t8 = P.StreamController_StreamController(null, null, null, null, false, O.Message);
        t5 = new T.WebRtcDataChannel(t1, t2, t3, null, null, null, H.assertSubtype(t4, "$isStreamController", [T.ConnectionState], "$asStreamController"), H.assertSubtype(t7, "$isStreamController", [O.NewMessageEvent], "$asStreamController"), sc, H.assertSubtype(t8, "$isStreamController", [O.Message], "$asStreamController"), H.assertSubtype(t6, "$isCompleter", [P.$int], "$asCompleter"), H.assertSubtype(t5, "$isCompleter", [P.$int], "$asCompleter"));
        t5.WebRtcDataChannel$1(sc);
        return t5;
      }}
  },
  WebRtcDataChannel_closure: {
    "^": "Closure:24;this_0,sc_1",
    call$1: function($event) {
      var t1, t2, t3, t4, t5;
      H.interceptedTypeCheck($event, "$isRtcDataChannelEvent");
      H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_INFO_800, "datachannel received", null, null));
      t1 = this.this_0;
      t2 = $event.channel;
      t1._dc = t2;
      t2.toString;
      t2 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_message._eventType, false), [null]), "$isStream", [H.getTypeArgumentByIndex(C.EventStreamProvider_message, 0)], "$asStream"), "$isStream", [W.MessageEvent], "$asStream");
      t3 = new T.WebRtcDataChannel__closure(t1);
      t4 = H.getVoidRuntimeType();
      H.buildFunctionType(t4, [t2.$tv_T()])._assertCheck$1(t3);
      t5 = H.buildFunctionType(t4);
      ...
      t2 = t1._dc;
      t2.toString;
      t2 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_open._eventType, false), [null]), "$isStream", [H.getTypeArgumentByIndex(C.EventStreamProvider_open, 0)], "$asStream"), "$isStream", [W.Event], "$asStream");
      t3 = new T.WebRtcDataChannel__closure0(t1, this.sc_1);
      H.buildFunctionType(t4, [t2.$tv_T()])._assertCheck$1(t3);
      t5._assertCheck$1(null);
      t3 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(t3), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
      t3._tryResume$0();
      ...
      t2 = t1._dc;
      t2.toString;
      t2 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_close._eventType, false), [null]), "$isStream", [H.getTypeArgumentByIndex(C.EventStreamProvider_close, 0)], "$asStream"), "$isStream", [W.Event], "$asStream");
      t3 = new T.WebRtcDataChannel__closure1(t1);
      H.buildFunctionType(t4, [t2.$tv_T()])._assertCheck$1(t3);
      t5._assertCheck$1(null);
      t3 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(t3), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
      t3._tryResume$0();
      ...
      t2 = t1._dc;
      t2.toString;
      t2 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_error._eventType, false), [null]), "$isStream", [H.getTypeArgumentByIndex(C.EventStreamProvider_error, 0)], "$asStream"), "$isStream", [W.Event], "$asStream");
      t3 = new T.WebRtcDataChannel__closure2();
      H.buildFunctionType(t4, [t2.$tv_T()])._assertCheck$1(t3);
      t5._assertCheck$1(null);
      t3 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(t3), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
      t3._tryResume$0();
  ...
  WebRtcDataChannel__closure: {
    ...
    call$1: function($event) {
      ...
      H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_FINEST_300, "Message received from DataChannel", null, null));
      t1 = this.this_2._newMessageController;
      t2 = new O.NewMessageEvent(null, null, null, null, false, null, null, null, null, null, null, O.Message_fromString(P.convertNativeToDart_AcceptStructuredClone($event.data, true)));
  ...
  WebRtcDataChannel__closure2: {
    "^": "Closure:11;",
    call$1: function(x) {
      return H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_SHOUT_1200, C.JSString_methods.$add("rtc error callback: ", J.toString$0(x)), null, null));
    },
    $isFunction: true
  },
  WebRtcDataChannel_gotSignalingMessage_closure: {
    "^": "Closure:10;",
    call$0: function() {
      return H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_INFO_800, "ice candidate added", null, null));
    },
    $isFunction: true
  },
  WebRtcDataChannel_gotSignalingMessage_closure0: {
    "^": "Closure:11;",
    call$1: function(error) {
      return H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_WARNING_900, J.toString$0(error), null, null));
    },
    $isFunction: true
  },
  ...
  WebRtcDataChannel_gotSignalingMessage_closure2: {
    "^": "Closure:11;",
    call$1: function(e) {
      return H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_SHOUT_1200, C.JSString_methods.$add("create answer: ", J.toString$0(e)), null, null));
    },
    $isFunction: true
  },
  ...
  WebRtcDataChannel_gotSignalingMessage_closure4: {
    "^": "Closure:11;",
    call$1: function(e) {
      return H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_SHOUT_1200, C.JSString_methods.$add("finish connection establishment", J.toString$0(e)), null, null));
    },
    $isFunction: true
  },
  WebRtcDataChannel_createAnswer_closure: {
    ...
    call$1: function(sdp_answer) {
      var t1, t2, jsonString, t3;
      H.interceptedTypeCheck(sdp_answer, "$isRtcSessionDescription");
      t1 = $.get$WebRtcDataChannel__log();
      H.voidTypeCheck(t1.log$4(C.Level_FINEST_300, "created sdp answer", null, null));
      t2 = this.this_0;
      C.RtcPeerConnection_methods.setLocalDescription$1(t2._rpc, sdp_answer);
      jsonString = C.JsonCodec_null_null.encode$1(P.LinkedHashMap_LinkedHashMap$_literal(["sdp", sdp_answer.sdp, "type", sdp_answer.type], null, null));
      t2 = t2._sc.otherside.newMessageController;
      t3 = new O.NewMessageEvent(null, null, null, null, false, null, null, null, null, null, null, new O.Message(jsonString, C.MessageType_WEBRTC_ANSWER_7));
      H.assertSubtypeOfRuntimeType(t3, H.getTypeArgumentByIndex(t2, 0));
      if (t2._state >= 4)
        H.throwExpression(t2._addEventError$0());
      t2._sendData$1(t3);
      H.voidTypeCheck(t1.log$4(C.Level_FINE_500, "sdp answer sent", null, null));
    },
    $isFunction: true
  },
  WebRtcDataChannel_createAnswer_closure0: {
    "^": "Closure:11;",
    call$1: function(e) {
      return H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_SHOUT_1200, "could not create answer", null, null));
    },
    $isFunction: true
  },
  WebRtcDataChannel_listen_closure: {
    ...
    call$1: function($event) {
      ...
      H.interceptedTypeCheck($event, "$isRtcIceCandidateEvent");
      t1 = $.get$WebRtcDataChannel__log();
      H.voidTypeCheck(t1.log$4(C.Level_FINEST_300, "new ice candidate received", null, null));
      t2 = $event.candidate;
      if (t2 != null) {
        ic = t2;
        try {
          ...
          t2 = H.stringTypeCheck(serializedIceCandidate);
          t3 = this.this_0._sc.otherside.newMessageController;
          t2 = new O.NewMessageEvent(null, null, null, null, false, null, null, null, null, null, null, new O.Message(t2, C.MessageType_ICE_CANDIDATE_5));
          H.assertSubtypeOfRuntimeType(t2, H.getTypeArgumentByIndex(t3, 0));
          if (t3._state >= 4)
            H.throwExpression(t3._addEventError$0());
          t3._sendData$1(t2);
          H.voidTypeCheck(t1.log$4(C.Level_FINE_500, "new ice candidate serialized and sent to other peer", null, null));
        } catch (exception) {
          t2 = H.unwrapException(exception);
          e = t2;
          H.voidTypeCheck(t1.log$4(C.Level_WARNING_900, C.JSString_methods.$add("bob error: could not add ice candidate ", J.toString$0(e)), null, null));
        }
  ...
  WebRtcDataChannel_connect_closure0: {
    ...
    call$1: function(_) {
      var t1;
      H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_INFO_800, "datachannel closed!", null, null));
      t1 = this.this_1;
      t1._setCommunicationState$1(T.ConnectionState_ConnectionState$fromRTCDataChannelState(t1._dc.readyState));
    },
    $isFunction: true
  ...
  WebRtcDataChannel_connect_closure1: {
    ...
    call$1: function($event) {
      ...
      H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_FINEST_300, "Message received from DataChannel", null, null));
      t1 = this.this_2._newMessageController;
      t2 = new O.NewMessageEvent(null, null, null, null, false, null, null, null, null, null, null, O.Message_fromString(P.convertNativeToDart_AcceptStructuredClone(J.get$_get_data$x($event), true)));
      H.assertSubtypeOfRuntimeType(t2, H.getRuntimeTypeArgument(t1, "_StreamController", 0));
      if (t1._state >= 4)
        H.throwExpression(t1._badEventState$0());
      t1._async$_add$1(t2);
  ...
  WebRtcDataChannel_connect_closure2: {
    ...
    call$1: function(sdp_offer) {
      ...
      t1 = $.get$WebRtcDataChannel__log();
      H.voidTypeCheck(t1.log$4(C.Level_FINEST_300, "create sdp offer", null, null));
      t2 = this.this_3;
      C.RtcPeerConnection_methods.setLocalDescription$1(t2._rpc, sdp_offer);
      H.voidTypeCheck(t1.log$4(C.Level_FINEST_300, "create map", null, null));
      ...
      H.voidTypeCheck(t1.log$4(C.Level_FINEST_300, C.JSString_methods.$add("sdp_string: ", sdp_string), null, null));
      t1 = H.stringTypeCheck(sdp_string);
      t2 = t2._sc.otherside.newMessageController;
      t1 = new O.NewMessageEvent(null, null, null, null, false, null, null, null, null, null, null, new O.Message(t1, C.MessageType_WEBRTC_OFFER_6));
      H.assertSubtypeOfRuntimeType(t1, H.getTypeArgumentByIndex(t2, 0));
      if (t2._state >= 4)
        H.throwExpression(t2._addEventError$0());
      t2._sendData$1(t1);
  ...
  WebRtcDataChannel__init_send_worker_closure: {
    ...
    call$1: function(msg) {
      ...
      H.interceptedTypeCheck(msg, "$isMessage");
      t1 = this.this_0;
      H.voidTypeCheck($.get$WebRtcDataChannel__log().log$4(C.Level_INFO_800, "send message to : " + C.JSInt_methods.toString$0(H.Primitives_objectHashCode(t1._sc)), null, null));
      J.send$1$x(t1._dc, O.Message_serialize(msg));
    },
    $isFunction: true
  }
}],
["messenger.events", "package:WebRTCMessenger/WebRTCMessenger/src/events.dart", , O, {
  "^": "",
  NewConnectionEvent: {
...
["messenger.message", "package:WebRTCMessenger/WebRTCMessenger/src/message.dart", , O, {
  "^": "",
  Message: {
    "^": "Object;_msg,_mtype",
    toString$0: function(_) {
    ...
    static: {Message_serialize: function(value) {
      ...
      }, Message_fromString: function(data) {
        var json, t1, t2;
        H.stringTypeCheck(data);
        if (data == null)
          return;
        json = H.assertSubtype(C.JsonCodec_null_null.decode$1(data), "$isMap", [P.String, P.String], "$asMap");
        t1 = json.$index(0, "msg");
        t2 = O.MessageType_MessageType$fromString(json.$index(0, "mtype"));
        return new O.Message(H.stringTypeCheck(t1), t2);
      }}
  },
  MessageType: {
    "^": "Object;name,value",
    ...
    static: {"^": "MessageType_STRING,MessageType_SERIALIZED,MessageType_SIGNAL,MessageType_UNDEFINED,MessageType_ICE_CANDIDATE,MessageType_WEBRTC_OFFER,MessageType_WEBRTC_ANSWER,MessageType_PEER_ID,MessageType_AKN_PEER_ID", MessageType_serialize: function(value) {
        ...
        if (data == null)
          return;
        switch (H.assertSubtype(C.JsonCodec_null_null.decode$1(data), "$isMap", [P.String, P.String], "$asMap").$index(0, "name")) {
          case "DC_CONNECTING":
...
["messenger.peer", "package:WebRTCMessenger/WebRTCMessenger/src/peer.dart", , S, {
  "^": "",
  Peer: {
    ...
    listen$1: function(c) {
      var t1, t2;
      H.assertSubtype(c.listen$0(), "$isFuture", [P.$int], "$asFuture").then$1(new S.Peer_listen_closure(this, c));
      t1 = this.newConnectionController;
      t1.toString;
      t2 = H.getTypeArgumentByIndex(t1, 0);
      return H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle")), [t2]), "$isStream", [H.getTypeArgumentByIndex(t1, 0)], "$asStream"), "$isStream", [O.NewConnectionEvent], "$asStream");
    },
    connect$1: function(c) {
      var t1, t2;
      H.assertSubtype(c.connect$0(), "$isFuture", [P.$int], "$asFuture").then$1(new S.Peer_connect_closure(this, c));
      t1 = this.newConnectionController;
      t1.toString;
      t2 = H.getTypeArgumentByIndex(t1, 0);
      return H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle")), [t2]), "$isStream", [H.getTypeArgumentByIndex(t1, 0)], "$asStream"), "$isStream", [O.NewConnectionEvent], "$asStream");
    ...
    Peer$2: function($name, loglevel) {
      ...
      if ($.hierarchicalLoggingEnabled && t1.parent != null)
        ...
        if (t1.parent != null)
          H.throwExpression(P.UnsupportedError$("Please set \"hierarchicalLoggingEnabled\" to true if you want to change the level on a non-root logger."));
        $._rootLevel = loglevel;
      }
      H.assertSubtype(t1._getStream$0(), "$isStream", [N.LogRecord], "$asStream").listen$1(new S.Peer_closure());
  ...
  Peer_listen_closure: {
    ...
    call$1: function(id) {
      ...
      H.voidTypeCheck(t1._log.log$4(C.Level_INFO_800, "new connection added! (now: " + C.JSInt_methods.toString$0(H.assertSubtype(t1._connections, "$isMap", [P.$int, T.Connection], "$asMap")._collection$_length) + ")", null, null));
      t3 = t1.newConnectionController;
      t4 = new O.NewConnectionEvent(null, null, null, null, false, null, null, null, null, null, null, t2);
      t3.toString;
      H.assertSubtypeOfRuntimeType(t4, H.getTypeArgumentByIndex(t3, 0));
      if (t3._state >= 4)
        H.throwExpression(t3._addEventError$0());
      t3._sendData$1(t4);
      t2 = t2._newMessageController;
      H.assertSubtype(t2, "$is_StreamControllerLifecycle", [null], "$as_StreamControllerLifecycle");
      H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new P._ControllerStream(H.assertSubtype(t2, "$is_StreamControllerLifecycle", [null], "$as_StreamControllerLifecycle")), [null]), "$isStream", [H.getRuntimeTypeArgument(t2, "_StreamController", 0)], "$asStream"), "$isStream", [O.NewMessageEvent], "$asStream").listen$1(new S.Peer_listen__closure(t1));
    },
    $isFunction: true
  },
  Peer_listen__closure: {
    ...
    call$1: function(e) {
      var t1;
      H.interceptedTypeCheck(e, "$isNewMessageEvent");
      t1 = this.this_2;
      H.voidTypeCheck(t1._log.log$4(C.Level_INFO_800, "message redirected", null, null));
      t1 = t1.newMessageController;
      t1.toString;
      H.assertSubtypeOfRuntimeType(e, H.getTypeArgumentByIndex(t1, 0));
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(e);
    },
  ...
  Peer_connect_closure: {
    ...
    call$1: function(id) {
      ...
      t2 = t2._newMessageController;
      H.assertSubtype(t2, "$is_StreamControllerLifecycle", [null], "$as_StreamControllerLifecycle");
      H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new P._ControllerStream(H.assertSubtype(t2, "$is_StreamControllerLifecycle", [null], "$as_StreamControllerLifecycle")), [null]), "$isStream", [H.getRuntimeTypeArgument(t2, "_StreamController", 0)], "$asStream"), "$isStream", [O.NewMessageEvent], "$asStream").listen$1(new S.Peer_connect__closure(t1));
    },
    $isFunction: true
  },
  ...
  Peer_broadcast_closure: {
    ...
    call$1: function(id) {
      ...
      J.send$1$x(t1._connections.$index(0, id), this.msg_2);
      ++this.box_0.num_0;
    },
    $isFunction: true
  }
}],
["messenger.signaling", "package:WebRTCMessenger/WebRTCMessenger/src/signaling.dart", , R, {
  "^": "",
  MessagePassing: {
    "^": "SignalingChannel;otherside,newMessageController,connection_completer",
    connect$1: function(options) {
      var t1, t2;
      H.assertSubtype(options, "$isMap", [P.String, R.MessagePassing], "$asMap");
      if (options.get$isEmpty(options))
        throw H.wrapException(P.StateError$("empty option set excatly one value expected. none found!"));
      t1 = options.get$values();
      t2 = t1._iterable;
      if (H.assertSubtypeOfRuntimeType(t1._f$1(t2.get$first(t2)), H.getTypeArgumentByIndex(t1, 1)) == null)
        throw H.wrapException(P.StateError$("first element is null, should be a messagepassing object!"));
      t1 = options.get$values();
      t2 = t1._iterable;
      this.otherside = H.interceptedTypeCheck(H.assertSubtypeOfRuntimeType(t1._f$1(t2.get$first(t2)), H.getTypeArgumentByIndex(t1, 1)), "$isMessagePassing");
    },
    send$1: function(_, message) {
      var t1, t2;
      H.interceptedTypeCheck(message, "$isMessage");
      t1 = this.otherside.newMessageController;
      t2 = new O.NewMessageEvent(null, null, null, null, false, null, null, null, null, null, null, message);
      H.assertSubtypeOfRuntimeType(t2, H.getTypeArgumentByIndex(t1, 0));
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(t2);
...
["unmodifiable_collection", "package:unmodifiable_collection/unmodifiable_collection.dart", , F, {
  ...
  UnmodifiableMapView: {
    ...
    $index: function(_, key) {
      return H.assertSubtypeOfRuntimeType(this._source.$index(0, H.assertSubtypeOfRuntimeType(key, H.getTypeArgumentByIndex(this, 0))), H.getTypeArgumentByIndex(this, 1));
    },
    forEach$1: function(_, f) {
      return H.voidTypeCheck(this._source.forEach$1(0, H.buildFunctionType(H.getVoidRuntimeType(), [this.$tv_K(), this.$tv_V()])._assertCheck$1(f)));
    },
    get$keys: function() {
      var t1 = this._source;
    ...
    get$values: function() {
      return H.listSuperNativeTypeCheck(this._source.get$values(), "$isIterable");
    },
    $indexSet: function(_, key, value) {
      H.assertSubtypeOfRuntimeType(key, H.getTypeArgumentByIndex(this, 0));
      H.assertSubtypeOfRuntimeType(value, H.getTypeArgumentByIndex(this, 1));
      return H.voidTypeCheck(F.UnmodifiableMapView__throw());
    },
    $isMap: true,
    $tv_K: function() {
      return H.convertRtiToRuntimeType(this.$builtinTypeInfo && this.$builtinTypeInfo[0]);
...
["", "webrtc_test.dart", , A, {
  "^": "",
  main: [function() {
    var alice, bob, t1, alice_bob_sc, bob_alice_sc, t2, a_b_c;
    alice = S.Peer$("alice_s3", C.Level_ALL_0);
    bob = S.Peer$("bob_s3", C.Level_ALL_0);
    t1 = P.String;
    ...
    alice_bob_sc = new R.MessagePassing(null, H.assertSubtype(null, "$isStreamController", [O.NewMessageEvent], "$asStreamController"), H.assertSubtype(t1, "$isCompleter", [P.String], "$asCompleter"));
    alice_bob_sc.set$newMessageController(P.StreamController_StreamController$broadcast(null, null, false, O.NewMessageEvent));
    t1 = P.String;
    t1 = H.assertSubtype(H.setRuntimeTypeInfo(new P._AsyncCompleter(H.assertSubtype(P._Future$(t1), "$is_Future", [t1], "$as_Future")), [t1]), "$isCompleter", [t1], "$asCompleter");
    bob_alice_sc = new R.MessagePassing(null, H.assertSubtype(null, "$isStreamController", [O.NewMessageEvent], "$asStreamController"), H.assertSubtype(t1, "$isCompleter", [P.String], "$asCompleter"));
    bob_alice_sc.set$newMessageController(P.StreamController_StreamController$broadcast(null, null, false, O.NewMessageEvent));
    alice_bob_sc.connect$1(H.assertSubtype(P.LinkedHashMap_LinkedHashMap$_literal([H.Primitives_objectHashCode(bob_alice_sc), bob_alice_sc], null, null), "$isMap", [P.String, R.MessagePassing], "$asMap"));
    bob_alice_sc.connect$1(H.assertSubtype(P.LinkedHashMap_LinkedHashMap$_literal([H.Primitives_objectHashCode(alice_bob_sc), alice_bob_sc], null, null), "$isMap", [P.String, R.MessagePassing], "$asMap"));
    t1 = alice.newMessageController;
    t1.toString;
    t2 = H.getTypeArgumentByIndex(t1, 0);
    H.assertSubtype(H.setRuntimeTypeInfo(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle")), [t2]), "$isStream", [H.getTypeArgumentByIndex(t1, 0)], "$asStream").listen$1(new A.main_closure());
    t1 = bob.newMessageController;
    t1.toString;
    t2 = H.getTypeArgumentByIndex(t1, 0);
    H.assertSubtype(H.setRuntimeTypeInfo(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle")), [t2]), "$isStream", [H.getTypeArgumentByIndex(t1, 0)], "$asStream").listen$1(new A.main_closure0());
    t1 = alice.newConnectionController;
    t1.toString;
    t2 = H.getTypeArgumentByIndex(t1, 0);
    H.assertSubtype(H.setRuntimeTypeInfo(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle")), [t2]), "$isStream", [H.getTypeArgumentByIndex(t1, 0)], "$asStream").listen$1(new A.main_closure1(alice, new O.Message("some random string from alice", C.MessageType_STRING_1)));
    t1 = bob.newConnectionController;
    t1.toString;
    t2 = H.getTypeArgumentByIndex(t1, 0);
    H.assertSubtype(H.setRuntimeTypeInfo(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle")), [t2]), "$isStream", [H.getTypeArgumentByIndex(t1, 0)], "$asStream").listen$1(new A.main_closure2(bob, new O.Message("some random string from bob", C.MessageType_STRING_1)));
    a_b_c = T.WebRtcDataChannel$(alice_bob_sc);
    alice.listen$1(T.WebRtcDataChannel$(bob_alice_sc));
    bob.connect$1(a_b_c);
  }, "call$0", "main$closure", 0, 0, 1],
  main_closure: {
    "^": "Closure:23;",
    call$1: function(mevent) {
      P.print(C.JSString_methods.$add("alice revceived message: ", J.toString$0(H.interceptedTypeCheck(mevent, "$isNewMessageEvent").data)));
    },
    $isFunction: true
  },
  main_closure0: {
  ...
  main_closure1: {
    "^": "Closure:11;alice_0,tm_alice_1",
    call$1: function(_) {
      var t1, t2;
      t1 = this.alice_0;
      t2 = H.assertSubtype(t1._connections, "$isMap", [P.$int, T.Connection], "$asMap");
      if (t2._collection$_length === 1) {
        t2.toString;
  ...
  main_closure2: {
    ...
    call$1: function(_) {
      ...
      if (t2._collection$_length === 1) {
        t2.toString;
        t1.broadcast$2(H.listSuperNativeTypeCheck(H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterable(t2), [H.getTypeArgumentByIndex(t2, 0)]), "$isIterable"), this.tm_bob_3);
      }
    },
    $isFunction: true
  }
...
O.NewMessageEvent.$isEvent = true;
...
N.Logger.$isLogger = true;
N.Logger.$isObject = true;
T.ConnectionState.$isConnectionState = true;
...
O.NewConnectionEvent.$isNewConnectionEvent = true;
O.NewConnectionEvent.$isEvent = true;
O.NewConnectionEvent.$isObject = true;
T.Connection.$isConnection = true;
...
J.get$_get_data$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$_get_data(receiver);
};
...
C.EventStreamProvider_close = H.setRuntimeTypeInfo(new W.EventStreamProvider("close"), [W.Event]);
C.EventStreamProvider_datachannel = H.setRuntimeTypeInfo(new W.EventStreamProvider("datachannel"), [W.RtcDataChannelEvent]);
C.EventStreamProvider_error = H.setRuntimeTypeInfo(new W.EventStreamProvider("error"), [W.Event]);
C.EventStreamProvider_icecandidate = H.setRuntimeTypeInfo(new W.EventStreamProvider("icecandidate"), [W.RtcIceCandidateEvent]);
...
Isolate.$lazy($, "_log", "WebRtcDataChannel__log", "get$WebRtcDataChannel__log", function() {
  return N.Logger_Logger("messenger.JsDataChannelConnection");
});
...
function dart_precompiled($collectedClasses) {
  ...
  MessageEvent.prototype.get$_get_data = function(receiver) {
  ...
  NewConnectionEvent.prototype.get$type = function(receiver) {
    return this.type;
  };
  ...
  function main_closure2(bob_2, tm_bob_3) {
    this.bob_2 = bob_2;
    this.tm_bob_3 = tm_bob_3;
  }
