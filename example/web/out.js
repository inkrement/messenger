...
["chrome.sockets", "package:chrome/gen/sockets.dart", , A, {
  ...
  ChromeSocketsTcpServer: {
    ...
    get$onAccept: function() {
      var t1 = this._onAccept._common$_controller;
      return H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]);
    },
    close$1: function(_, socketId) {
      var t1, completer;
      t1 = $.get$chrome();
      if (J.$index$asx(J.$index$asx(t1, "sockets"), "tcpServer") == null)
        this._throwNotAvailable$0();
      completer = F.ChromeCompleter$noArgs();
      J.$index$asx(J.$index$asx(t1, "sockets"), "tcpServer").callMethod$2("close", [socketId, completer._callback]);
      return completer._completer.future;
    },
    _throwNotAvailable$0: function() {
...
["chrome.src.common", "package:chrome/src/common.dart", , F, {
  ...
  }, "call$1", "jsify$closure", 2, 0, 18, 19],
  ChromeCompleter: {
  ...
  ChromeCompleter$oneArg_closure: {
    "^": "Closure:51;this_0,transformer_1",
    ...
    }, "call$0", "call$1", null, null, 0, 2, null, 27, 7, "call"],
    $isFunction: true
  },
  ChromeStreamController: {
    ...
    get$stream: function(_) {
      var t1 = this._common$_controller;
      return H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]);
    },
  ...
  ChromeStreamController$oneArg_closure: {
    "^": "Closure:51;this_0,transformer_1,returnVal_2",
    call$1: [function(arg1) {
      var t1, t2;
...
["", "chrome_packed_dart_app.dart", , Q, {
  "^": "",
  debug: function(str) {
    var t1, t2;
    t1 = document.querySelector("#logs");
    t2 = new P.DateTime(Date.now(), false);
    t2.DateTime$_now$0();
    J.insertAdjacentHtml$2$x(t1, "beforeend", t2.toString$0(0) + " " + str + "<br/>");
  },
  main: [function() {
    var sc, dc, t1;
    Q.debug("loading ...");
    N.Logger_Logger("").set$level(C.Level_ALL_0);
    N.Logger_Logger("").get$onRecord().listen$1(new Q.main_closure());
    Q.debug("start listening on local port " + C.JSInt_methods.toString$0(37123));
    sc = R.ChromeAppTCPSignaling$(37123);
    dc = T.WebRtcDataChannel$(sc);
    t1 = sc.newEventsController;
    H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new Q.main_closure0(sc, dc));
    t1 = sc.newMessageController;
    H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new Q.main_closure1());
    t1 = dc._CSStreamController;
    H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new Q.main_closure2(dc));
    H.setRuntimeTypeInfo(new P._ControllerStream(dc._newMessageController), [null]).listen$1(new Q.main_closure3());
    t1 = J.get$onClick$x(document.querySelector("#tcp_connect"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.main_closure4(sc, dc)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#tcp_close_button"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.main_closure5(sc)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 20],
  initWebRTCConnection: [function($status) {
    Q.debug(C.JSString_methods.$add("webrtc connection initated.. status: ", J.toString$0($status)));
  }, "call$1", "initWebRTCConnection$closure", 2, 0, 21, 22],
  uiNewTCPConnection: function(sc) {
    var t1;
    J.get$classes$x(document.querySelector("#tcp_connect_form")).add$1(0, "hidden");
    J.get$classes$x(document.querySelector("#tcp_send")).remove$1(0, "hidden");
    t1 = J.get$onClick$x(document.querySelector("#tcp_send_button"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Q.uiNewTCPConnection_closure(sc)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  main_closure: {
    "^": "Closure:53;",
    call$1: [function(rec) {
      P.print(rec.get$level().name + ": " + rec.get$time().toString$0(0) + ": " + rec.get$loggerName() + ": " + H.S(J.get$message$x(rec)));
    }, "call$1", null, 2, 0, null, 52, "call"],
    $isFunction: true
  },
  main_closure0: {
    "^": "Closure:54;sc_0,dc_1",
    call$1: [function(e) {
      Q.debug(C.JSString_methods.$add("new SignalingChannel event: ", J.get$name$x(e)));
      switch (e) {
        case C.SignalingChannelEvents_CONNECTED_4:
          break;
        case C.SignalingChannelEvents_LISTENING_2:
          J.setInnerHtml$1$x(document.querySelector("#info"), C.JSString_methods.$add("listening on port ", J.toString$0(this.sc_0.c_port)));
          break;
        case C.SignalingChannelEvents_NEW_INCOMING_CONNECTION_5:
          Q.uiNewTCPConnection(this.sc_0);
          this.dc_1.connect$0().then$1(Q.initWebRTCConnection$closure());
          break;
        case C.SignalingChannelEvents_NEW_OUTGOING_CONNECTION_6:
          break;
      }
  ...
  main_closure1: {
    "^": "Closure:55;",
    call$1: [function(e) {
      Q.debug(C.JSString_methods.$add("received: ", J.toString$0(J.get$data$x(e))));
    }, "call$1", null, 2, 0, null, 2, "call"],
    $isFunction: true
  },
  main_closure2: {
    ...
    call$1: [function(cs) {
      ...
      t2 = J.toLowerCase$0$s(t1.get$name(cs));
      J.setInnerHtml$1$x(document.querySelector("#rtcstatus"), t2);
      if (t1.$eq(cs, C.ConnectionState_CONNECTED_12))
        this.dc_2.send$1(0, new O.MessengerMessage("first webrtc message", C.MessageType_STRING_1));
  ...
  main_closure3: {
    "^": "Closure:55;",
    call$1: [function(ev) {
      Q.debug(C.JSString_methods.$add("received first webrtc message :", ev.getMessage$0()._msg));
    }, "call$1", null, 2, 0, null, 58, "call"],
    $isFunction: true
  },
  main_closure4: {
    "^": "Closure:18;sc_3,dc_4",
    call$1: [function(_) {
      var t1;
      Q.debug("try to connect to tcp server");
      this.dc_4.listen$0().then$1(Q.initWebRTCConnection$closure());
      t1 = this.sc_3;
      t1.connect$1(P.LinkedHashMap_LinkedHashMap$_literal(["host", J.get$value$x(document.querySelector("#host")), "port", J.toString$0(H.Primitives_parseInt(J.get$value$x(document.querySelector("#localport")), null, null))], null, null));
      Q.uiNewTCPConnection(t1);
  ...
  main_closure5: {
    ...
    call$1: [function(_) {
      var t1, t2;
      Q.debug("close tcp connection");
      t1 = this.sc_5;
      t2 = t1.client;
      if (t2 != null)
        t2.dispose$0();
      t1 = t1.connection_completer.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1("connection closed");
      J.get$classes$x(document.querySelector("#tcp_connect_form")).remove$1(0, "hidden");
      J.get$classes$x(document.querySelector("#tcp_send")).add$1(0, "hidden");
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  uiNewTCPConnection_closure: {
    "^": "Closure:18;sc_0",
    call$1: [function(_) {
      var txt, t1, t2, t3;
      Q.debug("send tcp message");
      txt = document.querySelector("#tcp_message");
      t1 = J.getInterceptor$x(txt);
      t2 = J.$add$ns(t1.get$value(txt), "\n");
      t3 = this.sc_0.client;
      if (t3 == null)
        H.throwExpression(R.NotConnected$("No valid socket available"));
      t3.writeString$1(t2);
      t1.set$value(txt, "");
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
...
["dart.async", "dart:async", , P, {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 66, 28, 29],
...
["dart.convert", "dart:convert", , P, {
  ...
  }, "call$1", "_defaultToEncodable$closure", 2, 0, 33, 0],
  _JsonMap: {
...
["dart.dom.html", "dart:html", , W, {
  ...
  RtcPeerConnection_RtcPeerConnection: function(rtcIceServers, mediaConstraints) {
    var constructorName = window[H.S(P.Device_propertyPrefix()) + "RTCPeerConnection"];
    return new constructorName(P._convertDartToNative_PrepareForStructuredClone(rtcIceServers));
  },
  RtcSessionDescription_RtcSessionDescription: function(dictionary) {
    var t1 = P.Device_isFirefox() === true ? H.S(P.Device_propertyPrefix()) + "RTCSessionDescription" : "RTCSessionDescription";
    return new window[t1](P._convertDartToNative_PrepareForStructuredClone(dictionary));
  },
  ...
  Event: {
    "^": "Interceptor;type=",
    $isEvent: true,
    "%": "AudioProcessingEvent|AutocompleteErrorEvent|BeforeLoadEvent|BeforeUnloadEvent|CSSFontFaceLoadEvent|CloseEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|InstallPhaseEvent|MIDIConnectionEvent|MediaKeyNeededEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|RTCDTMFToneChangeEvent|ResourceProgressEvent|SecurityPolicyViolationEvent|SpeechInputEvent|SpeechRecognitionEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent|XMLHttpRequestProgressEvent;ClipboardEvent|Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
  ...
  RtcIceCandidate: {
    "^": "Interceptor;candidate=,sdpMLineIndex=,sdpMid=",
  ...
  RtcPeerConnection: {
    ...
    createOffer$0: function($receiver) {
      return this.createOffer$1($receiver, null);
    },
    ...
    _createOffer_2$2: function(receiver, successCallback, failureCallback) {
      return receiver.createOffer(H.convertDartClosureToJS(successCallback, 1), H.convertDartClosureToJS(failureCallback, 1));
    },
  ...
  _Html5NodeValidator: {
    ...
    static: {"^": "_Html5NodeValidator__allowedElements,_Html5NodeValidator__standardAttributes,_Html5NodeValidator__uriAttributes,_Html5NodeValidator__attributeValidators", _Html5NodeValidator$: function(uriPolicy) {
        ...
        return true;
      }, "call$4", "_Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 37, 38, 39, 25, 40], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
        var t1, t2, t3, t4, t5;
        ...
        if (!t1)
          ...
          t1 = true;
        return t1;
      }, "call$4", "_Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 37, 38, 39, 25, 40]}
  },
  ImmutableListMixin: {
    "^": "Object;",
    get$iterator: function(receiver) {
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$4", "_callDartFunction$closure", 8, 0, null, 41, 42, 43, 44],
  ...
  }, "call$1", "_convertToJS$closure", 2, 0, 18, 45],
  ...
  }, "call$1", "_convertToDart$closure", 2, 0, 33, 45],
...
["html_common", "dart:html_common", , P, {
  ...
  Device_propertyPrefix: function() {
    var t1 = $.Device__cachedPropertyPrefix;
    if (t1 == null)
...
["messenger.connections", "package:messenger/messenger/src/connections.dart", , T, {
  ...
  Connection: {
    ...
    _setCommunicationState$1: function(readyState) {
      ...
      if (this.readyState === readyState)
        return;
      $.get$Connection__log().fine$1("change state: " + readyState.name);
    ...
    send$1: function(_, msg) {
      var t1;
      $.get$Connection__log().fine$1(C.JSString_methods.$add("new message added to buffer: ", msg.getContent$0()));
  ...
  WebRtcDataChannel: {
    "^": "Connection;iceServers,pcConstraint,_dcOptions,_rpc,_dc,readyState,_CSStreamController,_newMessageController,_sc,_sendController,_connection_completer,_listen_completer",
    gotSignalingMessage$1: [function(mevent) {
      var t1, t2, iceCandidate, sdp;
      switch (mevent.getMessage$0()._mtype) {
        case C.MessageType_ICE_CANDIDATE_5:
          $.get$WebRtcDataChannel__log().finest$1("got ice candidate");
          t1 = C.JsonCodec_null_null.decode$1(mevent.getMessage$0()._msg);
          t2 = P.Device_isFirefox() === true ? H.S(P.Device_propertyPrefix()) + "RTCIceCandidate" : "RTCIceCandidate";
          iceCandidate = new window[t2](P._convertDartToNative_PrepareForStructuredClone(t1));
          C.RtcPeerConnection_methods.addIceCandidate$3(this._rpc, iceCandidate, new T.WebRtcDataChannel_gotSignalingMessage_closure(), new T.WebRtcDataChannel_gotSignalingMessage_closure0());
          break;
        case C.MessageType_WEBRTC_OFFER_6:
          $.get$WebRtcDataChannel__log().fine$1("received sdp offer");
          sdp = W.RtcSessionDescription_RtcSessionDescription(C.JsonCodec_null_null.decode$1(mevent.getMessage$0()._msg));
          C.RtcPeerConnection_methods.setRemoteDescription$1(this._rpc, sdp).then$1(new T.WebRtcDataChannel_gotSignalingMessage_closure1(this)).catchError$1(new T.WebRtcDataChannel_gotSignalingMessage_closure2());
          break;
        case C.MessageType_WEBRTC_ANSWER_7:
          $.get$WebRtcDataChannel__log().fine$1("received sdp answer");
          sdp = W.RtcSessionDescription_RtcSessionDescription(C.JsonCodec_null_null.decode$1(mevent.getMessage$0()._msg));
          C.RtcPeerConnection_methods.setRemoteDescription$1(this._rpc, sdp).then$1(new T.WebRtcDataChannel_gotSignalingMessage_closure3(this)).catchError$1(new T.WebRtcDataChannel_gotSignalingMessage_closure4());
          break;
        default:
          $.get$WebRtcDataChannel__log().info$1("New undefined signaling channel message: " + J.toString$0(mevent.getMessage$0()));
          break;
      }
    }, "call$1", "get$gotSignalingMessage", 2, 0, 55, 77],
    createAnswer$0: function(_) {
      C.RtcPeerConnection_methods.createAnswer$0(this._rpc).then$1(new T.WebRtcDataChannel_createAnswer_closure(this)).catchError$1(new T.WebRtcDataChannel_createAnswer_closure0());
    },
    listen$0: function() {
      $.get$WebRtcDataChannel__log().finest$1("start listening");
      ...
      t1 = H.setRuntimeTypeInfo(new W._EventStream(this._rpc, C.EventStreamProvider_icecandidate._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.WebRtcDataChannel_listen_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      return this._listen_completer.future;
    },
    connect$0: function() {
      var e, t1, exception;
      t1 = $.get$WebRtcDataChannel__log();
      t1.finest$1("try to connect");
      this.listen$0();
      try {
        this._dc = C.RtcPeerConnection_methods.createDataChannel$2(this._rpc, "sendDataChannel", this._dcOptions);
        ...
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.WebRtcDataChannel_connect_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = this._dc;
        t1.toString;
        t1 = H.setRuntimeTypeInfo(new W._EventStream(t1, C.EventStreamProvider_close._eventType, false), [null]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.WebRtcDataChannel_connect_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = this._dc;
        t1.toString;
        t1 = H.setRuntimeTypeInfo(new W._EventStream(t1, C.EventStreamProvider_message._eventType, false), [null]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.WebRtcDataChannel_connect_closure1(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        C.RtcPeerConnection_methods.createOffer$0(this._rpc).then$1(new T.WebRtcDataChannel_connect_closure2(this));
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e = t1;
    ...
    _init_send_worker$0: function() {
      ...
      H.setRuntimeTypeInfo(new P._ControllerStream(this._sendController), [null]).listen$1(new T.WebRtcDataChannel__init_send_worker_closure(this));
    },
    WebRtcDataChannel$1: function(sc) {
      var t1;
      $.get$WebRtcDataChannel__log().finest$1("created PeerConnection");
      t1 = W.RtcPeerConnection_RtcPeerConnection(this.iceServers, null);
      this._rpc = t1;
      t1 = H.setRuntimeTypeInfo(new W._EventStream(t1, C.EventStreamProvider_datachannel._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.WebRtcDataChannel_closure(this, sc)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {"^": "WebRtcDataChannel__log", WebRtcDataChannel$: function(sc) {
        var t1, t2, t3, t4, t5, t6;
        t1 = P.LinkedHashMap_LinkedHashMap$_literal(["iceServers", [P.LinkedHashMap_LinkedHashMap$_literal(["url", "stun:stun.l.google.com:19302"], null, null)]], null, null);
        ...
        t5 = new T.WebRtcDataChannel(t1, t2, t3, null, null, null, t4, P.StreamController_StreamController(null, null, null, null, false, O.NewMessageEvent), sc, P.StreamController_StreamController(null, null, null, null, false, O.MessengerMessage), t6, t5);
        t5.WebRtcDataChannel$1(sc);
        return t5;
      }}
  },
  WebRtcDataChannel_closure: {
    "^": "Closure:79;this_0,sc_1",
    call$1: [function($event) {
      var t1, t2;
      $.get$WebRtcDataChannel__log().info$1("datachannel received");
      t1 = this.this_0;
      t2 = J.get$channel$x($event);
      t1._dc = t2;
      t2.toString;
      t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_message._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new T.WebRtcDataChannel__closure(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = t1._dc;
      t2.toString;
      t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_open._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new T.WebRtcDataChannel__closure0(t1, this.sc_1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = t1._dc;
      t2.toString;
      t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_close._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new T.WebRtcDataChannel__closure1(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = t1._dc;
      t2.toString;
      t2 = H.setRuntimeTypeInfo(new W._EventStream(t2, C.EventStreamProvider_error._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new T.WebRtcDataChannel__closure2()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1._setCommunicationState$1(T.ConnectionState_ConnectionState$fromRTCDataChannelState(t1._dc.readyState));
    }, "call$1", null, 2, 0, null, 78, "call"],
    $isFunction: true
  },
  WebRtcDataChannel__closure: {
    "^": "Closure:80;this_2",
    call$1: [function($event) {
      var t1, t2;
      $.get$WebRtcDataChannel__log().finest$1("Message received from DataChannel");
      t1 = this.this_2._newMessageController;
      t2 = O.MessengerMessage_fromString(J.get$data$x($event));
      if (t1._state >= 4)
        H.throwExpression(t1._badEventState$0());
  ...
  WebRtcDataChannel__closure0: {
    "^": "Closure:18;this_3,sc_4",
    call$1: [function(_) {
      var t1, t2;
      t1 = this.this_3;
      t1._setCommunicationState$1(T.ConnectionState_ConnectionState$fromRTCDataChannelState(t1._dc.readyState));
  ...
  WebRtcDataChannel__closure2: {
    "^": "Closure:18;",
    call$1: [function(x) {
      return $.get$WebRtcDataChannel__log().shout$1(C.JSString_methods.$add("rtc error callback: ", J.toString$0(x)));
    }, "call$1", null, 2, 0, null, 81, "call"],
    $isFunction: true
  },
  WebRtcDataChannel_gotSignalingMessage_closure: {
    "^": "Closure:47;",
    call$0: [function() {
      return $.get$WebRtcDataChannel__log().info$1("ice candidate added");
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  WebRtcDataChannel_gotSignalingMessage_closure0: {
    "^": "Closure:18;",
    call$1: [function(error) {
      return $.get$WebRtcDataChannel__log().warning$1(J.toString$0(error));
    }, "call$1", null, 2, 0, null, 28, "call"],
    $isFunction: true
  },
  WebRtcDataChannel_gotSignalingMessage_closure1: {
    "^": "Closure:18;this_0",
    call$1: [function(_) {
      this.this_0.createAnswer$0(0);
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  WebRtcDataChannel_gotSignalingMessage_closure2: {
    "^": "Closure:18;",
    call$1: [function(e) {
      return $.get$WebRtcDataChannel__log().shout$1(C.JSString_methods.$add("create answer: ", J.toString$0(e)));
    }, "call$1", null, 2, 0, null, 2, "call"],
    $isFunction: true
  },
  WebRtcDataChannel_gotSignalingMessage_closure3: {
    "^": "Closure:18;this_1",
    call$1: [function(_) {
      this.this_1.createAnswer$0(0);
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  WebRtcDataChannel_gotSignalingMessage_closure4: {
    "^": "Closure:18;",
    call$1: [function(e) {
      return $.get$WebRtcDataChannel__log().shout$1(C.JSString_methods.$add("finish connection establishment", J.toString$0(e)));
    }, "call$1", null, 2, 0, null, 2, "call"],
    $isFunction: true
  },
  WebRtcDataChannel_createAnswer_closure: {
    "^": "Closure:83;this_0",
    call$1: [function(sdp_answer) {
      var t1, t2, t3;
      t1 = $.get$WebRtcDataChannel__log();
      t1.finest$1("created sdp answer");
      t2 = this.this_0;
      C.RtcPeerConnection_methods.setLocalDescription$1(t2._rpc, sdp_answer);
      t3 = J.getInterceptor$x(sdp_answer);
      t3 = O.MessengerMessage_serialize(new O.MessengerMessage(C.JsonCodec_null_null.encode$1(P.LinkedHashMap_LinkedHashMap$_literal(["sdp", t3.get$sdp(sdp_answer), "type", t3.get$type(sdp_answer)], null, null)), C.MessageType_WEBRTC_ANSWER_7));
      t2 = t2._sc.client;
      if (t2 == null)
        H.throwExpression(R.NotConnected$("No valid socket available"));
      t2.writeString$1(t3);
      t1.fine$1("sdp answer sent");
    }, "call$1", null, 2, 0, null, 82, "call"],
    $isFunction: true
  },
  WebRtcDataChannel_createAnswer_closure0: {
    "^": "Closure:18;",
    call$1: [function(e) {
      return $.get$WebRtcDataChannel__log().shout$1("could not create answer");
    }, "call$1", null, 2, 0, null, 2, "call"],
    $isFunction: true
  },
  WebRtcDataChannel_listen_closure: {
    "^": "Closure:84;this_0",
    call$1: [function($event) {
      var ic, serializedIceCandidate, e, t1, t2, t3, exception;
      t1 = $.get$WebRtcDataChannel__log();
      t1.finest$1("new ice candidate received");
      t2 = J.getInterceptor$x($event);
      if (t2.get$candidate($event) != null) {
        ic = t2.get$candidate($event);
        try {
          serializedIceCandidate = C.JsonCodec_null_null.encode$1(P.LinkedHashMap_LinkedHashMap$_literal(["candidate", J.get$candidate$x(ic), "sdpMLineIndex", J.get$sdpMLineIndex$x(ic), "sdpMid", J.get$sdpMid$x(ic)], null, null));
          t2 = O.MessengerMessage_serialize(new O.MessengerMessage(serializedIceCandidate, C.MessageType_ICE_CANDIDATE_5));
          t3 = this.this_0._sc.client;
          if (t3 == null)
            H.throwExpression(R.NotConnected$("No valid socket available"));
          t3.writeString$1(t2);
          t1.fine$1("new ice candidate serialized and sent to other peer");
        } catch (exception) {
          t2 = H.unwrapException(exception);
          e = t2;
          t1.warning$1(C.JSString_methods.$add("bob error: could not add ice candidate ", J.toString$0(e)));
        }
  ...
  WebRtcDataChannel_connect_closure: {
    "^": "Closure:18;this_0",
    call$1: [function(_) {
      var t1, t2;
      t1 = this.this_0;
  ...
  WebRtcDataChannel_connect_closure0: {
    "^": "Closure:18;this_1",
    call$1: [function(_) {
      var t1;
      $.get$WebRtcDataChannel__log().info$1("datachannel closed!");
      t1 = this.this_1;
      t1._setCommunicationState$1(T.ConnectionState_ConnectionState$fromRTCDataChannelState(t1._dc.readyState));
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  WebRtcDataChannel_connect_closure1: {
    "^": "Closure:80;this_2",
    call$1: [function($event) {
      var t1, t2;
      $.get$WebRtcDataChannel__log().finest$1("Message received from DataChannel");
  ...
  WebRtcDataChannel_connect_closure2: {
    "^": "Closure:18;this_3",
    call$1: [function(sdp_offer) {
      var sdp_map, sdp_string, t1, t2;
      t1 = $.get$WebRtcDataChannel__log();
      t1.finest$1("create sdp offer");
      t2 = this.this_3;
      C.RtcPeerConnection_methods.setLocalDescription$1(t2._rpc, sdp_offer);
      t1.finest$1("create map");
      sdp_map = P.LinkedHashMap_LinkedHashMap$_literal(["sdp", J.get$sdp$x(sdp_offer), "type", J.get$type$x(sdp_offer)], null, null);
      sdp_string = C.JsonCodec_null_null.encode$1(sdp_map);
      t1.finest$1(C.JSString_methods.$add("sdp_string: ", sdp_string));
      t1 = O.MessengerMessage_serialize(new O.MessengerMessage(sdp_string, C.MessageType_WEBRTC_OFFER_6));
      t2 = t2._sc.client;
      if (t2 == null)
        H.throwExpression(R.NotConnected$("No valid socket available"));
      t2.writeString$1(t1);
  ...
  WebRtcDataChannel__init_send_worker_closure: {
    "^": "Closure:87;this_0",
    call$1: [function(msg) {
      var t1 = this.this_0;
      $.get$WebRtcDataChannel__log().info$1("send message to : " + C.JSInt_methods.toString$0(H.Primitives_objectHashCode(t1._sc)));
      t1._dc.send(O.MessengerMessage_serialize(msg));
...
["messenger.exceptions", "package:messenger/messenger/src/exceptions.dart", , R, {
  ...
  BadConfiguration: {
    "^": "Object;cause",
    static: {BadConfiguration$: function(cause) {
        return new R.BadConfiguration(cause);
      }}
  },
...
["messenger.message", "package:messenger/messenger/src/messengermessage.dart", , O, {
  "^": "",
  MessageType: {
    "^": "Object;name>,value>",
    toString$0: function(_) {
    ...
    static: {"^": "MessageType__log,MessageType_STRING,MessageType_SERIALIZED,MessageType_SIGNAL,MessageType_UNDEFINED,MessageType_ICE_CANDIDATE,MessageType_WEBRTC_OFFER,MessageType_WEBRTC_ANSWER,MessageType_PEER_ID,MessageType_AKN_PEER_ID", MessageType_serialize: function(value) {
      ...
      }, MessageType_MessageType$fromString: function(data) {
        var json, t1;
        if (data == null)
          throw H.wrapException(P.Exception_Exception("can not create messagetype from null"));
        json = C.JsonCodec_null_null.decode$1(data);
        t1 = J.getInterceptor$asx(json);
        $.get$MessageType__log().info$1(C.JSString_methods.$add("json name enth\u00e4lt das: ", t1.$index(json, "name")));
        switch (t1.$index(json, "name")) {
          case "DC_CONNECTING":
  ...
  MessengerMessage: {
    "^": "Object;_msg<,_mtype<",
    toString$0: function(_) {
      return C.JSString_methods.$add(this._mtype.name + " (", this._msg) + ")";
    },
    getContent$0: function() {
      return this._msg;
    },
    static: {MessengerMessage_serialize: function(value) {
        ...
        if (value == null)
          return;
        result = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
        result.$indexSet(0, "msg", value.get$_msg());
        result.$indexSet(0, "mtype", O.MessageType_serialize(value.get$_mtype()));
        return C.JsonCodec_null_null.encode$1(result);
      }, MessengerMessage_fromString: function(data) {
        var json, t1;
        if (data == null)
          return;
        json = C.JsonCodec_null_null.decode$1(data);
        t1 = J.getInterceptor$asx(json);
        return new O.MessengerMessage(t1.$index(json, "msg"), O.MessageType_MessageType$fromString(t1.$index(json, "mtype")));
      }}
  }
}],
["messenger.signaling", "package:messenger/messenger/src/signaling.dart", , R, {
  ...
  ChromeAppTCPSignaling: {
    "^": "SignalingChannel;start_port,max_attempts,socketId<,connection_socket_id,c_port,c_host,l_host,client,newMessageController,connection_completer,newEventsController",
    connect$1: function(options) {
      var t1;
      if (options.containsKey$1("host"))
        this.c_host = options.$index(0, "host");
      if (!options.containsKey$1("port"))
        throw H.wrapException(R.BadConfiguration$("TCPSignaling channel needs a port configuration"));
      this.c_port = H.Primitives_parseInt(options.$index(0, "port"), null, null);
      t1 = this.client;
      if (t1 != null)
        t1.dispose$0();
      $.get$ChromeAppTCPSignaling__log().info$1(C.JSString_methods.$add(C.JSString_methods.$add("connect to ", this.c_host) + " ", J.toString$0(this.c_port)));
      F.TcpClient_createClient(this.c_host, this.c_port, true).then$1(new R.ChromeAppTCPSignaling_connect_closure(this)).catchError$1(new R.ChromeAppTCPSignaling_connect_closure0(this));
    },
    send$1: function(_, message) {
      var t1, t2;
      t1 = O.MessengerMessage_serialize(message);
      t2 = this.client;
      if (t2 == null)
        H.throwExpression(R.NotConnected$("No valid socket available"));
      t2.writeString$1(t1);
    },
    ChromeAppTCPSignaling$1: function(port) {
      var t1;
      $.get$ChromeAppTCPSignaling__log().finest$1("instantiate new ChromeAppTCPSignaling object");
      $.get$sockets().tcpServer;
      if (J.$index$asx(J.$index$asx($.get$chrome(), "sockets"), "tcpServer") == null)
        throw H.wrapException(R.ChromeApiNotAvailable$("chrome socket API not available"));
      this.c_port = port;
      t1 = this.newEventsController;
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(C.SignalingChannelEvents_CREATED_1);
      F.TcpServer_createServerSocket(port).then$1(new R.ChromeAppTCPSignaling_closure(this));
    },
    static: {"^": "ChromeAppTCPSignaling__log", ChromeAppTCPSignaling$: function(port) {
        var t1 = P.String;
        t1 = new R.ChromeAppTCPSignaling(8543, 10, null, -1, null, "127.0.0.1", "127.0.0.1", null, null, H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]), null);
        t1.SignalingChannel$0();
        t1.ChromeAppTCPSignaling$1(port);
        return t1;
      }}
  },
  ChromeAppTCPSignaling_closure: {
    ...
    call$1: [function(s) {
      var t1, t2;
      t1 = this.this_0;
      t2 = t1.newEventsController;
      if (t2._state >= 4)
        H.throwExpression(t2._addEventError$0());
      t2._sendData$1(C.SignalingChannelEvents_LISTENING_2);
      s.get$onAccept().listen$1(new R.ChromeAppTCPSignaling__closure(t1));
  ...
  ChromeAppTCPSignaling__closure: {
    ...
    call$1: [function(c) {
      var t1, t2;
      $.get$ChromeAppTCPSignaling__log().fine$1("listen for incoming connections");
      t1 = this.this_1;
      t1.client = c;
      t2 = t1.newEventsController;
      if (t2._state >= 4)
        H.throwExpression(t2._addEventError$0());
      t2._sendData$1(C.SignalingChannelEvents_NEW_INCOMING_CONNECTION_5);
      J.get$stream$x(c).listen$1(new R.ChromeAppTCPSignaling___closure(t1));
  ...
  ChromeAppTCPSignaling___closure: {
    ...
    call$1: [function(data) {
      var msg, t1;
      msg = O.MessengerMessage_fromString(C.Utf8Codec_false.decode$1(data));
      $.get$ChromeAppTCPSignaling__log().info$1("new Signaling Message: " + J.toString$0(msg));
      t1 = this.this_2.newMessageController;
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(new O.NewMessageEvent(null, null, null, null, false, null, null, null, null, null, null, msg));
    }, "call$1", null, 2, 0, null, 65, "call"],
    $isFunction: true
  },
  ChromeAppTCPSignaling_connect_closure: {
    "^": "Closure:91;this_0",
    call$1: [function(c) {
      var t1, t2;
      t1 = this.this_0;
      ...
      if (t2._state >= 4)
        H.throwExpression(t2._addEventError$0());
      t2._sendData$1(C.SignalingChannelEvents_NEW_OUTGOING_CONNECTION_6);
      t1.client = c;
      J.get$stream$x(c).listen$1(new R.ChromeAppTCPSignaling_connect__closure(t1));
    }, "call$1", null, 2, 0, null, 90, "call"],
    $isFunction: true
  },
  ChromeAppTCPSignaling_connect__closure: {
    "^": "Closure:92;this_1",
    call$1: [function(data) {
      var msg, t1;
      msg = O.MessengerMessage_fromString(C.Utf8Codec_false.decode$1(data));
      $.get$ChromeAppTCPSignaling__log().info$1("new Signaling Message: " + J.toString$0(msg));
      t1 = this.this_1.newMessageController;
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(new O.NewMessageEvent(null, null, null, null, false, null, null, null, null, null, null, msg));
    }, "call$1", null, 2, 0, null, 65, "call"],
  ...
  ChromeAppTCPSignaling_connect_closure0: {
    "^": "Closure:18;this_2",
    call$1: [function(error) {
      var t1;
      $.get$ChromeAppTCPSignaling__log().warning$1(J.toString$0(error));
      t1 = this.this_2.newEventsController;
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(C.SignalingChannelEvents_NOT_ABLE_TO_LISTEN_3);
    }, "call$1", null, 2, 0, null, 28, "call"],
    $isFunction: true
  },
  SignalingChannel: {
    "^": "Object;",
    SignalingChannel$0: function() {
      this.newMessageController = P.StreamController_StreamController$broadcast(null, null, false, O.NewMessageEvent);
      this.newEventsController = P.StreamController_StreamController$broadcast(null, null, false, R.SignalingChannelEvents);
    }
  },
  SignalingChannelEvents: {
    "^": "Object;name>,value>",
    static: {"^": "SignalingChannelEvents_CREATED,SignalingChannelEvents_LISTENING,SignalingChannelEvents_NOT_ABLE_TO_LISTEN,SignalingChannelEvents_CONNECTED,SignalingChannelEvents_NEW_INCOMING_CONNECTION,SignalingChannelEvents_NEW_OUTGOING_CONNECTION"}
  }
}],
["spark.tcp", "package:messenger/messenger/src/helpers/tcphelpers.dart", , F, {
  "^": "",
  SocketException: {
    "^": "Object;message>,code",
    toString$0: function(_) {
    ...
    static: {SocketException$: function(message, code) {
        return new F.SocketException(message, code);
      }}
  },
  TcpClient: {
    "^": "Object;_lastWrite,_socketId",
    get$stream: function(_) {
      var t1 = $.TcpClient__clientMap.$index(0, this._socketId);
      t1.toString;
      return H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]);
    },
    write$1: function($event) {
      var t1, t2, t3, completer;
      t1 = $.get$sockets().tcp;
      t2 = J.$index$asx($.get$context(), "Uint8Array");
      t3 = [];
      C.JSArray_methods.addAll$1(t3, $event.map$1($event, P._convertToJS$closure()));
      t3 = J.$index$asx(P.JsObject_JsObject(t2, [H.setRuntimeTypeInfo(new P.JsArray(t3), [null])]), "buffer");
      t2 = $.get$chrome();
      ...
      J.$index$asx(J.$index$asx(t2, "sockets"), "tcp").callMethod$2("send", [this._socketId, F.jsify(new Z.ArrayBuffer(t3)), completer._callback]);
      this._lastWrite = completer._completer.future;
    },
    writeString$1: function(str) {
      var t1, t2, t3, t4, completer;
      t1 = J.get$codeUnits$s(str);
      t2 = $.get$sockets().tcp;
      t3 = J.$index$asx($.get$context(), "Uint8Array");
      t4 = [];
      C.JSArray_methods.addAll$1(t4, t1.map$1(t1, P._convertToJS$closure()));
      t4 = J.$index$asx(P.JsObject_JsObject(t3, [H.setRuntimeTypeInfo(new P.JsArray(t4), [null])]), "buffer");
      t1 = $.get$chrome();
      if (J.$index$asx(J.$index$asx(t1, "sockets"), "tcp") == null)
        t2._throwNotAvailable$0();
      completer = F.ChromeCompleter$oneArg(A._createSendInfo$closure());
      J.$index$asx(J.$index$asx(t1, "sockets"), "tcp").callMethod$2("send", [this._socketId, F.jsify(new Z.ArrayBuffer(t4)), completer._callback]);
      this._lastWrite = completer._completer.future;
      return;
    },
    dispose$0: function() {
      return this._lastWrite.then$1(new F.TcpClient_dispose_closure(this));
    },
    TcpClient$_fromSocketId$2: function(_socketId, unpause) {
      var t1, t2, t3, completer;
      if ($.TcpClient__clientMap == null)
        F.TcpClient__initListeners();
      t1 = this._socketId;
      ...
      if (unpause) {
        ...
        if (J.$index$asx(J.$index$asx(t3, "sockets"), "tcp") == null)
          t2._throwNotAvailable$0();
        completer = F.ChromeCompleter$noArgs();
        J.$index$asx(J.$index$asx(t3, "sockets"), "tcp").callMethod$2("setPaused", [t1, false, completer._callback]);
      }
    },
    static: {"^": "TcpClient__clientMap", TcpClient_createClient: function(host, port, throwOnError) {
        var t1, t2, completer;
        if (J.$index$asx(J.$index$asx($.get$context(), "chrome"), "sockets") == null)
          return P._Future$immediateError("chrome.sockets API not available", null, null);
        t1 = $.get$sockets().tcp;
        t2 = $.get$chrome();
        if (J.$index$asx(J.$index$asx(t2, "sockets"), "tcp") == null)
          return P._Future$immediateError("chrome.sockets API not available", null, null);
        ...
        return completer._completer.future.then$1(new F.TcpClient_createClient_closure(host, port, throwOnError));
      }, TcpClient__initListeners: function() {
        var t1, t2;
        $.TcpClient__clientMap = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
        t1 = $.get$sockets().tcp;
        t2 = t1._onReceive._common$_controller;
        H.setRuntimeTypeInfo(new P._BroadcastStream(t2), [H.getTypeArgumentByIndex(t2, 0)]).listen$1(new F.TcpClient__initListeners_closure());
        t1 = t1._onReceiveError._common$_controller;
        H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new F.TcpClient__initListeners_closure0());
      }, TcpClient$_fromSocketId: function(_socketId, unpause) {
        var t1 = new F.TcpClient(P._Future$immediate(null, null), _socketId);
        t1.TcpClient$_fromSocketId$2(_socketId, unpause);
        return t1;
      }}
  },
  TcpClient_createClient_closure: {
    "^": "Closure:94;host_0,port_1,throwOnError_2",
    call$1: [function(createInfo) {
      var socketId, t1, t2, t3, t4, completer;
      socketId = createInfo.get$socketId();
      t1 = $.get$sockets().tcp;
      t2 = this.host_0;
      t3 = this.port_1;
      t4 = $.get$chrome();
      ...
      J.$index$asx(J.$index$asx(t4, "sockets"), "tcp").callMethod$2("connect", [socketId, t2, t3, completer._callback]);
      t1 = this.throwOnError_2;
      return completer._completer.future.then$1(new F.TcpClient_createClient__closure(t2, t3, t1, socketId)).catchError$1(new F.TcpClient_createClient__closure0(t2, t3, t1));
    }, "call$1", null, 2, 0, null, 93, "call"],
    $isFunction: true
  },
  TcpClient_createClient__closure: {
    "^": "Closure:75;host_3,port_4,throwOnError_5,socketId_6",
    call$1: [function(result) {
      var t1 = this.socketId_6;
      if (J.$lt$n(result, 0)) {
        $.get$sockets().tcp.close$1(0, t1);
        if (!this.throwOnError_5)
          return;
        throw H.wrapException(F.SocketException$("unable to connect to " + H.S(this.host_3) + " " + H.S(this.port_4) + ": " + H.S(result), 0));
      } else
        return F.TcpClient$_fromSocketId(t1, false);
    }, "call$1", null, 2, 0, null, 95, "call"],
    $isFunction: true
  },
  TcpClient_createClient__closure0: {
    "^": "Closure:18;host_7,port_8,throwOnError_9",
    call$1: [function(e) {
      if (!this.throwOnError_9)
        return;
      throw H.wrapException(F.SocketException$("unable to connect to " + H.S(this.host_7) + " " + H.S(this.port_8) + ": " + H.S(J.toString$0(e)), 0));
    }, "call$1", null, 2, 0, null, 2, "call"],
    $isFunction: true
  },
  TcpClient__initListeners_closure: {
    ...
    call$1: [function(info) {
      var controller, t1;
      controller = $.TcpClient__clientMap.$index(0, info.get$socketId());
      if (controller != null) {
        t1 = J.get$data$x(info).getBytes$0();
  ...
  TcpClient__initListeners_closure0: {
    "^": "Closure:98;",
    call$1: [function(info) {
      var socket, controller, t1, t2;
      socket = info.get$socketId();
      controller = $.TcpClient__clientMap.$index(0, socket);
      if (controller != null)
        if (J.$eq(info.get$resultCode(), -15)) {
          controller.close$0(0);
          $.TcpClient__clientMap.remove$1(0, socket);
        } else {
          t1 = new F.SocketException("error reading stream: " + H.S(info.get$resultCode()), info.get$resultCode());
          if (controller._state >= 4)
            H.throwExpression(controller._badEventState$0());
  ...
  TcpClient_dispose_closure: {
    "^": "Closure:18;this_0",
    call$1: [function(_) {
      var t1 = this.this_0._socketId;
      $.TcpClient__clientMap.remove$1(0, t1);
      return $.get$sockets().tcp.close$1(0, t1);
    }, "call$1", null, 2, 0, null, 59, "call"],
    $isFunction: true
  },
  TcpServer: {
    ...
    get$onAccept: function() {
      var t1 = $.TcpServer__serverMap.$index(0, this._socketId);
      t1.toString;
      return H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]);
    },
    dispose$0: function() {
      var t1 = this._socketId;
      $.TcpServer__serverMap.remove$1(0, t1);
      return $.get$sockets().tcpServer.close$1(0, t1);
    },
    TcpServer$_$2: function(_socketId, port) {
      if ($.TcpServer__serverMap == null)
        F.TcpServer__initListener();
    ...
    static: {"^": "TcpServer__serverMap", TcpServer_createServerSocket: function(port) {
        ...
        if (J.$index$asx(J.$index$asx(t2, "sockets"), "tcpServer") == null)
          return P._Future$immediateError("chrome.sockets.tcpServer API not available", null, null);
        if (J.$index$asx(J.$index$asx(t2, "sockets"), "tcpServer") == null)
          t1._throwNotAvailable$0();
        completer = F.ChromeCompleter$oneArg(A._createCreateInfo$closure());
        J.$index$asx(J.$index$asx(t2, "sockets"), "tcpServer").callMethod$2("create", [F.jsify(null), completer._callback]);
        return completer._completer.future.then$1(new F.TcpServer_createServerSocket_closure(port));
      }, TcpServer__initListener: function() {
        $.TcpServer__serverMap = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
        var t1 = $.get$sockets().tcpServer._onAccept._common$_controller;
        H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new F.TcpServer__initListener_closure());
      }}
  },
  TcpServer_createServerSocket_closure: {
    ...
    call$1: [function(info) {
      ...
      if (J.$index$asx(J.$index$asx(t3, "sockets"), "tcpServer") == null)
        t1._throwNotAvailable$0();
      completer = F.ChromeCompleter$oneArg(null);
      J.$index$asx(J.$index$asx(t3, "sockets"), "tcpServer").callMethod$2("listen", [socketId, "0.0.0.0", t2, 5, completer._callback]);
      return completer._completer.future.then$1(new F.TcpServer_createServerSocket__closure(t2, socketId));
    }, "call$1", null, 2, 0, null, 96, "call"],
    $isFunction: true
  },
  TcpServer_createServerSocket__closure: {
    "^": "Closure:75;port_1,socketId_2",
    call$1: [function(result) {
      var t1, t2, t3, completer;
      t1 = this.socketId_2;
      if (J.$lt$n(result, 0)) {
        $.get$sockets().tcpServer.close$1(0, t1);
        throw H.wrapException(F.SocketException$("unable to listen on port " + this.port_1 + ": " + H.S(result), 0));
      } else {
        ...
        J.$index$asx(J.$index$asx(t3, "sockets"), "tcpServer").callMethod$2("getInfo", [t1, completer._callback]);
        return completer._completer.future.then$1(new F.TcpServer_createServerSocket___closure(t1));
      }
    }, "call$1", null, 2, 0, null, 95, "call"],
    $isFunction: true
  },
  TcpServer_createServerSocket___closure: {
    "^": "Closure:99;socketId_3",
    call$1: [function(info) {
      var t1, t2, t3;
      t1 = this.socketId_3;
      t2 = info.get$localPort();
      t3 = new F.TcpServer(t1, t2);
  ...
  TcpServer__initListener_closure: {
    ...
    call$1: [function(info) {
      var controller, t1;
      controller = $.TcpServer__serverMap.$index(0, info.get$socketId());
      if (controller != null) {
        t1 = F.TcpClient$_fromSocketId(info.get$clientSocketId(), true);
        if (controller._state >= 4)
          H.throwExpression(controller._badEventState$0());
        controller._async$_add$1(t1);
      }
...
;(function() {
  ...
  _ = T.ConnectionState;
  _.$isConnectionState = TRUE;
  _.$isObject = TRUE;
  _ = O.NewMessageEvent;
  _.$isNewMessageEvent = TRUE;
  _.$isObject = TRUE;
  _ = O.MessengerMessage;
  _.$isMessengerMessage = TRUE;
  _.$isObject = TRUE;
  _ = W.RtcDataChannelEvent;
  _.$isRtcDataChannelEvent = TRUE;
  _.$isObject = TRUE;
  ...
  _.$isSendInfo = TRUE;
  _.$isObject = TRUE;
  _ = R.SignalingChannelEvents;
  _.$isSignalingChannelEvents = TRUE;
  _.$isObject = TRUE;
  _ = W.NodeValidator;
  _.$isNodeValidator = TRUE;
  _.$isObject = TRUE;
  _ = W.RtcSessionDescription;
  _.$isRtcSessionDescription = TRUE;
  _.$isObject = TRUE;
  _ = W.RtcIceCandidateEvent;
  _.$isRtcIceCandidateEvent = TRUE;
  _.$isObject = TRUE;
  _ = N.LogRecord;
  _.$isLogRecord = TRUE;
  _.$isObject = TRUE;
...
J.get$sdp$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$sdp(receiver);
};
J.get$sdpMLineIndex$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$sdpMLineIndex(receiver);
};
J.get$sdpMid$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$sdpMid(receiver);
};
...
C.SignalingChannelEvents_CONNECTED_4 = new R.SignalingChannelEvents("CONNECTED", 4);
C.SignalingChannelEvents_CREATED_1 = new R.SignalingChannelEvents("CREATED", 1);
C.SignalingChannelEvents_LISTENING_2 = new R.SignalingChannelEvents("LISTENING", 2);
C.SignalingChannelEvents_NEW_INCOMING_CONNECTION_5 = new R.SignalingChannelEvents("NEW_INCOMING_CONNECTION", 5);
C.SignalingChannelEvents_NEW_OUTGOING_CONNECTION_6 = new R.SignalingChannelEvents("NEW_OUTGOING_CONNECTION", 6);
C.SignalingChannelEvents_NOT_ABLE_TO_LISTEN_3 = new R.SignalingChannelEvents("NOT_ABLE_TO_LISTEN", 3);
...
Isolate.$lazy($, "_log", "Connection__log", "get$Connection__log", function() {
  return N.Logger_Logger("messenger.Connection");
});
Isolate.$lazy($, "_log", "WebRtcDataChannel__log", "get$WebRtcDataChannel__log", function() {
  return N.Logger_Logger("messenger.connections.WebRtcDataChannel");
});
Isolate.$lazy($, "_log", "MessageType__log", "get$MessageType__log", function() {
  return N.Logger_Logger("messenger.message.MessageType");
});
Isolate.$lazy($, "_log", "ChromeAppTCPSignaling__log", "get$ChromeAppTCPSignaling__log", function() {
  return N.Logger_Logger("messenger.signaling.ChromeAppTCPSignaling");
});
// Native classes
...
{func: "dynamic__SignalingChannelEvents", args: [R.SignalingChannelEvents]},
{func: "dynamic__NewMessageEvent", args: [O.NewMessageEvent]},
"cs",
{func: "dynamic__ConnectionState", args: [T.ConnectionState]},
"ev",
"_",
...
"x",
"sdp_answer",
{func: "dynamic__RtcSessionDescription", args: [W.RtcSessionDescription]},
{func: "dynamic__RtcIceCandidateEvent", args: [W.RtcIceCandidateEvent]},
"sdp_offer",
"msg",
{func: "dynamic__MessengerMessage", args: [O.MessengerMessage]},
"s",
{func: "dynamic__TcpServer", args: [F.TcpServer]},
"c",
{func: "dynamic__TcpClient", args: [F.TcpClient]},
...
function dart_precompiled($collectedClasses) {
  ...
  RtcDataChannelEvent.prototype.get$channel = function(receiver) {
  ...
  RtcIceCandidate.prototype.get$sdpMLineIndex = function(receiver) {
    return receiver.sdpMLineIndex;
  };
  RtcIceCandidate.prototype.get$sdpMid = function(receiver) {
    return receiver.sdpMid;
  };
  ...
  RtcSessionDescription.prototype.get$sdp = function(receiver) {
    return receiver.sdp;
  };
  ...
  function main_closure0(sc_0, dc_1) {
    this.sc_0 = sc_0;
    this.dc_1 = dc_1;
  }
  ...
  function main_closure4(sc_3, dc_4) {
    this.sc_3 = sc_3;
    this.dc_4 = dc_4;
  }
  ...
  function uiNewTCPConnection_closure(sc_0) {
    this.sc_0 = sc_0;
  }
  uiNewTCPConnection_closure.builtin$cls = "uiNewTCPConnection_closure";
  if (!"name" in uiNewTCPConnection_closure)
    uiNewTCPConnection_closure.name = "uiNewTCPConnection_closure";
  $desc = $collectedClasses.uiNewTCPConnection_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  uiNewTCPConnection_closure.prototype = $desc;
  ...
  function RtcPeerConnection_createOffer_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  RtcPeerConnection_createOffer_closure.builtin$cls = "RtcPeerConnection_createOffer_closure";
  if (!"name" in RtcPeerConnection_createOffer_closure)
    RtcPeerConnection_createOffer_closure.name = "RtcPeerConnection_createOffer_closure";
  $desc = $collectedClasses.RtcPeerConnection_createOffer_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RtcPeerConnection_createOffer_closure.prototype = $desc;
  function RtcPeerConnection_createOffer_closure0(completer_1) {
    this.completer_1 = completer_1;
  }
  RtcPeerConnection_createOffer_closure0.builtin$cls = "RtcPeerConnection_createOffer_closure0";
  if (!"name" in RtcPeerConnection_createOffer_closure0)
    RtcPeerConnection_createOffer_closure0.name = "RtcPeerConnection_createOffer_closure0";
  $desc = $collectedClasses.RtcPeerConnection_createOffer_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RtcPeerConnection_createOffer_closure0.prototype = $desc;
  function RtcPeerConnection_createAnswer_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  RtcPeerConnection_createAnswer_closure.builtin$cls = "RtcPeerConnection_createAnswer_closure";
  if (!"name" in RtcPeerConnection_createAnswer_closure)
    RtcPeerConnection_createAnswer_closure.name = "RtcPeerConnection_createAnswer_closure";
  $desc = $collectedClasses.RtcPeerConnection_createAnswer_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RtcPeerConnection_createAnswer_closure.prototype = $desc;
  function RtcPeerConnection_createAnswer_closure0(completer_1) {
    this.completer_1 = completer_1;
  }
  RtcPeerConnection_createAnswer_closure0.builtin$cls = "RtcPeerConnection_createAnswer_closure0";
  if (!"name" in RtcPeerConnection_createAnswer_closure0)
    RtcPeerConnection_createAnswer_closure0.name = "RtcPeerConnection_createAnswer_closure0";
  $desc = $collectedClasses.RtcPeerConnection_createAnswer_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RtcPeerConnection_createAnswer_closure0.prototype = $desc;
  function RtcPeerConnection_setLocalDescription_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  RtcPeerConnection_setLocalDescription_closure.builtin$cls = "RtcPeerConnection_setLocalDescription_closure";
  if (!"name" in RtcPeerConnection_setLocalDescription_closure)
    RtcPeerConnection_setLocalDescription_closure.name = "RtcPeerConnection_setLocalDescription_closure";
  $desc = $collectedClasses.RtcPeerConnection_setLocalDescription_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RtcPeerConnection_setLocalDescription_closure.prototype = $desc;
  function RtcPeerConnection_setLocalDescription_closure0(completer_1) {
    this.completer_1 = completer_1;
  }
  RtcPeerConnection_setLocalDescription_closure0.builtin$cls = "RtcPeerConnection_setLocalDescription_closure0";
  if (!"name" in RtcPeerConnection_setLocalDescription_closure0)
    RtcPeerConnection_setLocalDescription_closure0.name = "RtcPeerConnection_setLocalDescription_closure0";
  $desc = $collectedClasses.RtcPeerConnection_setLocalDescription_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RtcPeerConnection_setLocalDescription_closure0.prototype = $desc;
  function RtcPeerConnection_setRemoteDescription_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  RtcPeerConnection_setRemoteDescription_closure.builtin$cls = "RtcPeerConnection_setRemoteDescription_closure";
  if (!"name" in RtcPeerConnection_setRemoteDescription_closure)
    RtcPeerConnection_setRemoteDescription_closure.name = "RtcPeerConnection_setRemoteDescription_closure";
  $desc = $collectedClasses.RtcPeerConnection_setRemoteDescription_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RtcPeerConnection_setRemoteDescription_closure.prototype = $desc;
  function RtcPeerConnection_setRemoteDescription_closure0(completer_1) {
    this.completer_1 = completer_1;
  }
  RtcPeerConnection_setRemoteDescription_closure0.builtin$cls = "RtcPeerConnection_setRemoteDescription_closure0";
  if (!"name" in RtcPeerConnection_setRemoteDescription_closure0)
    RtcPeerConnection_setRemoteDescription_closure0.name = "RtcPeerConnection_setRemoteDescription_closure0";
  $desc = $collectedClasses.RtcPeerConnection_setRemoteDescription_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RtcPeerConnection_setRemoteDescription_closure0.prototype = $desc;
  ...
  function WebRtcDataChannel(iceServers, pcConstraint, _dcOptions, _rpc, _dc, readyState, _CSStreamController, _newMessageController, _sc, _sendController, _connection_completer, _listen_completer) {
  ...
  WebRtcDataChannel.builtin$cls = "WebRtcDataChannel";
  if (!"name" in WebRtcDataChannel)
    WebRtcDataChannel.name = "WebRtcDataChannel";
  $desc = $collectedClasses.WebRtcDataChannel;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel.prototype = $desc;
  function WebRtcDataChannel_closure(this_0, sc_1) {
    this.this_0 = this_0;
    this.sc_1 = sc_1;
  }
  WebRtcDataChannel_closure.builtin$cls = "WebRtcDataChannel_closure";
  if (!"name" in WebRtcDataChannel_closure)
    WebRtcDataChannel_closure.name = "WebRtcDataChannel_closure";
  $desc = $collectedClasses.WebRtcDataChannel_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_closure.prototype = $desc;
  function WebRtcDataChannel__closure(this_2) {
    this.this_2 = this_2;
  }
  WebRtcDataChannel__closure.builtin$cls = "WebRtcDataChannel__closure";
  if (!"name" in WebRtcDataChannel__closure)
    WebRtcDataChannel__closure.name = "WebRtcDataChannel__closure";
  $desc = $collectedClasses.WebRtcDataChannel__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel__closure.prototype = $desc;
  function WebRtcDataChannel__closure0(this_3, sc_4) {
    this.this_3 = this_3;
    this.sc_4 = sc_4;
  }
  WebRtcDataChannel__closure0.builtin$cls = "WebRtcDataChannel__closure0";
  if (!"name" in WebRtcDataChannel__closure0)
    WebRtcDataChannel__closure0.name = "WebRtcDataChannel__closure0";
  $desc = $collectedClasses.WebRtcDataChannel__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel__closure0.prototype = $desc;
  function WebRtcDataChannel__closure1(this_5) {
    this.this_5 = this_5;
  }
  WebRtcDataChannel__closure1.builtin$cls = "WebRtcDataChannel__closure1";
  if (!"name" in WebRtcDataChannel__closure1)
    WebRtcDataChannel__closure1.name = "WebRtcDataChannel__closure1";
  $desc = $collectedClasses.WebRtcDataChannel__closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel__closure1.prototype = $desc;
  function WebRtcDataChannel__closure2() {
  }
  WebRtcDataChannel__closure2.builtin$cls = "WebRtcDataChannel__closure2";
  if (!"name" in WebRtcDataChannel__closure2)
    WebRtcDataChannel__closure2.name = "WebRtcDataChannel__closure2";
  $desc = $collectedClasses.WebRtcDataChannel__closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel__closure2.prototype = $desc;
  function WebRtcDataChannel_gotSignalingMessage_closure() {
  }
  WebRtcDataChannel_gotSignalingMessage_closure.builtin$cls = "WebRtcDataChannel_gotSignalingMessage_closure";
  if (!"name" in WebRtcDataChannel_gotSignalingMessage_closure)
    WebRtcDataChannel_gotSignalingMessage_closure.name = "WebRtcDataChannel_gotSignalingMessage_closure";
  $desc = $collectedClasses.WebRtcDataChannel_gotSignalingMessage_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_gotSignalingMessage_closure.prototype = $desc;
  function WebRtcDataChannel_gotSignalingMessage_closure0() {
  }
  WebRtcDataChannel_gotSignalingMessage_closure0.builtin$cls = "WebRtcDataChannel_gotSignalingMessage_closure0";
  if (!"name" in WebRtcDataChannel_gotSignalingMessage_closure0)
    WebRtcDataChannel_gotSignalingMessage_closure0.name = "WebRtcDataChannel_gotSignalingMessage_closure0";
  $desc = $collectedClasses.WebRtcDataChannel_gotSignalingMessage_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_gotSignalingMessage_closure0.prototype = $desc;
  function WebRtcDataChannel_gotSignalingMessage_closure1(this_0) {
    this.this_0 = this_0;
  }
  WebRtcDataChannel_gotSignalingMessage_closure1.builtin$cls = "WebRtcDataChannel_gotSignalingMessage_closure1";
  if (!"name" in WebRtcDataChannel_gotSignalingMessage_closure1)
    WebRtcDataChannel_gotSignalingMessage_closure1.name = "WebRtcDataChannel_gotSignalingMessage_closure1";
  $desc = $collectedClasses.WebRtcDataChannel_gotSignalingMessage_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_gotSignalingMessage_closure1.prototype = $desc;
  function WebRtcDataChannel_gotSignalingMessage_closure2() {
  }
  WebRtcDataChannel_gotSignalingMessage_closure2.builtin$cls = "WebRtcDataChannel_gotSignalingMessage_closure2";
  if (!"name" in WebRtcDataChannel_gotSignalingMessage_closure2)
    WebRtcDataChannel_gotSignalingMessage_closure2.name = "WebRtcDataChannel_gotSignalingMessage_closure2";
  $desc = $collectedClasses.WebRtcDataChannel_gotSignalingMessage_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_gotSignalingMessage_closure2.prototype = $desc;
  function WebRtcDataChannel_gotSignalingMessage_closure3(this_1) {
    this.this_1 = this_1;
  }
  WebRtcDataChannel_gotSignalingMessage_closure3.builtin$cls = "WebRtcDataChannel_gotSignalingMessage_closure3";
  if (!"name" in WebRtcDataChannel_gotSignalingMessage_closure3)
    WebRtcDataChannel_gotSignalingMessage_closure3.name = "WebRtcDataChannel_gotSignalingMessage_closure3";
  $desc = $collectedClasses.WebRtcDataChannel_gotSignalingMessage_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_gotSignalingMessage_closure3.prototype = $desc;
  function WebRtcDataChannel_gotSignalingMessage_closure4() {
  }
  WebRtcDataChannel_gotSignalingMessage_closure4.builtin$cls = "WebRtcDataChannel_gotSignalingMessage_closure4";
  if (!"name" in WebRtcDataChannel_gotSignalingMessage_closure4)
    WebRtcDataChannel_gotSignalingMessage_closure4.name = "WebRtcDataChannel_gotSignalingMessage_closure4";
  $desc = $collectedClasses.WebRtcDataChannel_gotSignalingMessage_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_gotSignalingMessage_closure4.prototype = $desc;
  function WebRtcDataChannel_createAnswer_closure(this_0) {
    this.this_0 = this_0;
  }
  WebRtcDataChannel_createAnswer_closure.builtin$cls = "WebRtcDataChannel_createAnswer_closure";
  if (!"name" in WebRtcDataChannel_createAnswer_closure)
    WebRtcDataChannel_createAnswer_closure.name = "WebRtcDataChannel_createAnswer_closure";
  $desc = $collectedClasses.WebRtcDataChannel_createAnswer_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_createAnswer_closure.prototype = $desc;
  function WebRtcDataChannel_createAnswer_closure0() {
  }
  WebRtcDataChannel_createAnswer_closure0.builtin$cls = "WebRtcDataChannel_createAnswer_closure0";
  if (!"name" in WebRtcDataChannel_createAnswer_closure0)
    WebRtcDataChannel_createAnswer_closure0.name = "WebRtcDataChannel_createAnswer_closure0";
  $desc = $collectedClasses.WebRtcDataChannel_createAnswer_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_createAnswer_closure0.prototype = $desc;
  function WebRtcDataChannel_listen_closure(this_0) {
    this.this_0 = this_0;
  }
  WebRtcDataChannel_listen_closure.builtin$cls = "WebRtcDataChannel_listen_closure";
  if (!"name" in WebRtcDataChannel_listen_closure)
    WebRtcDataChannel_listen_closure.name = "WebRtcDataChannel_listen_closure";
  $desc = $collectedClasses.WebRtcDataChannel_listen_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_listen_closure.prototype = $desc;
  function WebRtcDataChannel_connect_closure(this_0) {
    this.this_0 = this_0;
  }
  WebRtcDataChannel_connect_closure.builtin$cls = "WebRtcDataChannel_connect_closure";
  if (!"name" in WebRtcDataChannel_connect_closure)
    WebRtcDataChannel_connect_closure.name = "WebRtcDataChannel_connect_closure";
  $desc = $collectedClasses.WebRtcDataChannel_connect_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_connect_closure.prototype = $desc;
  function WebRtcDataChannel_connect_closure0(this_1) {
    this.this_1 = this_1;
  }
  WebRtcDataChannel_connect_closure0.builtin$cls = "WebRtcDataChannel_connect_closure0";
  if (!"name" in WebRtcDataChannel_connect_closure0)
    WebRtcDataChannel_connect_closure0.name = "WebRtcDataChannel_connect_closure0";
  $desc = $collectedClasses.WebRtcDataChannel_connect_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_connect_closure0.prototype = $desc;
  function WebRtcDataChannel_connect_closure1(this_2) {
    this.this_2 = this_2;
  }
  WebRtcDataChannel_connect_closure1.builtin$cls = "WebRtcDataChannel_connect_closure1";
  if (!"name" in WebRtcDataChannel_connect_closure1)
    WebRtcDataChannel_connect_closure1.name = "WebRtcDataChannel_connect_closure1";
  $desc = $collectedClasses.WebRtcDataChannel_connect_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_connect_closure1.prototype = $desc;
  function WebRtcDataChannel_connect_closure2(this_3) {
    this.this_3 = this_3;
  }
  WebRtcDataChannel_connect_closure2.builtin$cls = "WebRtcDataChannel_connect_closure2";
  if (!"name" in WebRtcDataChannel_connect_closure2)
    WebRtcDataChannel_connect_closure2.name = "WebRtcDataChannel_connect_closure2";
  $desc = $collectedClasses.WebRtcDataChannel_connect_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel_connect_closure2.prototype = $desc;
  function WebRtcDataChannel__init_send_worker_closure(this_0) {
    this.this_0 = this_0;
  }
  WebRtcDataChannel__init_send_worker_closure.builtin$cls = "WebRtcDataChannel__init_send_worker_closure";
  if (!"name" in WebRtcDataChannel__init_send_worker_closure)
    WebRtcDataChannel__init_send_worker_closure.name = "WebRtcDataChannel__init_send_worker_closure";
  $desc = $collectedClasses.WebRtcDataChannel__init_send_worker_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebRtcDataChannel__init_send_worker_closure.prototype = $desc;
  ...
  NewMessageEvent.prototype.get$type = function(receiver) {
    return this.type;
  };
  NewMessageEvent.prototype.get$data = function(receiver) {
    return this.data;
  };
  function BadConfiguration(cause) {
    this.cause = cause;
  }
  BadConfiguration.builtin$cls = "BadConfiguration";
  if (!"name" in BadConfiguration)
    BadConfiguration.name = "BadConfiguration";
  $desc = $collectedClasses.BadConfiguration;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BadConfiguration.prototype = $desc;
  ...
  MessengerMessage.prototype.get$_msg = function() {
    return this._msg;
  };
  MessengerMessage.prototype.get$_mtype = function() {
    return this._mtype;
  };
  function ChromeAppTCPSignaling(start_port, max_attempts, socketId, connection_socket_id, c_port, c_host, l_host, client, newMessageController, connection_completer, newEventsController) {
    ...
    this.newEventsController = newEventsController;
  }
  ...
  ChromeAppTCPSignaling.prototype.get$socketId = function() {
    return this.socketId;
  };
  function ChromeAppTCPSignaling_closure(this_0) {
    this.this_0 = this_0;
  }
  ...
  function ChromeAppTCPSignaling_connect_closure(this_0) {
    this.this_0 = this_0;
  }
  ChromeAppTCPSignaling_connect_closure.builtin$cls = "ChromeAppTCPSignaling_connect_closure";
  if (!"name" in ChromeAppTCPSignaling_connect_closure)
    ChromeAppTCPSignaling_connect_closure.name = "ChromeAppTCPSignaling_connect_closure";
  $desc = $collectedClasses.ChromeAppTCPSignaling_connect_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChromeAppTCPSignaling_connect_closure.prototype = $desc;
  function ChromeAppTCPSignaling_connect__closure(this_1) {
    this.this_1 = this_1;
  }
  ChromeAppTCPSignaling_connect__closure.builtin$cls = "ChromeAppTCPSignaling_connect__closure";
  if (!"name" in ChromeAppTCPSignaling_connect__closure)
    ChromeAppTCPSignaling_connect__closure.name = "ChromeAppTCPSignaling_connect__closure";
  $desc = $collectedClasses.ChromeAppTCPSignaling_connect__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChromeAppTCPSignaling_connect__closure.prototype = $desc;
  function ChromeAppTCPSignaling_connect_closure0(this_2) {
    this.this_2 = this_2;
  }
  ChromeAppTCPSignaling_connect_closure0.builtin$cls = "ChromeAppTCPSignaling_connect_closure0";
  if (!"name" in ChromeAppTCPSignaling_connect_closure0)
    ChromeAppTCPSignaling_connect_closure0.name = "ChromeAppTCPSignaling_connect_closure0";
  $desc = $collectedClasses.ChromeAppTCPSignaling_connect_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChromeAppTCPSignaling_connect_closure0.prototype = $desc;
  ...
  function SignalingChannelEvents(name, value) {
    this.name = name;
    this.value = value;
  }
  SignalingChannelEvents.builtin$cls = "SignalingChannelEvents";
  if (!"name" in SignalingChannelEvents)
    SignalingChannelEvents.name = "SignalingChannelEvents";
  $desc = $collectedClasses.SignalingChannelEvents;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SignalingChannelEvents.prototype = $desc;
  SignalingChannelEvents.prototype.get$name = function(receiver) {
    return this.name;
  };
  SignalingChannelEvents.prototype.get$value = function(receiver) {
    return this.value;
  };
  ...
  SocketException.prototype.get$message = function(receiver) {
    return this.message;
  };
  ...
  function TcpClient_createClient_closure(host_0, port_1, throwOnError_2) {
    this.host_0 = host_0;
    this.port_1 = port_1;
    this.throwOnError_2 = throwOnError_2;
  }
  TcpClient_createClient_closure.builtin$cls = "TcpClient_createClient_closure";
  if (!"name" in TcpClient_createClient_closure)
    TcpClient_createClient_closure.name = "TcpClient_createClient_closure";
  $desc = $collectedClasses.TcpClient_createClient_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TcpClient_createClient_closure.prototype = $desc;
  function TcpClient_createClient__closure(host_3, port_4, throwOnError_5, socketId_6) {
    this.host_3 = host_3;
    this.port_4 = port_4;
    this.throwOnError_5 = throwOnError_5;
    this.socketId_6 = socketId_6;
  }
  TcpClient_createClient__closure.builtin$cls = "TcpClient_createClient__closure";
  if (!"name" in TcpClient_createClient__closure)
    TcpClient_createClient__closure.name = "TcpClient_createClient__closure";
  $desc = $collectedClasses.TcpClient_createClient__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TcpClient_createClient__closure.prototype = $desc;
  function TcpClient_createClient__closure0(host_7, port_8, throwOnError_9) {
    this.host_7 = host_7;
    this.port_8 = port_8;
    this.throwOnError_9 = throwOnError_9;
  }
  TcpClient_createClient__closure0.builtin$cls = "TcpClient_createClient__closure0";
  if (!"name" in TcpClient_createClient__closure0)
    TcpClient_createClient__closure0.name = "TcpClient_createClient__closure0";
  $desc = $collectedClasses.TcpClient_createClient__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TcpClient_createClient__closure0.prototype = $desc;
  ...
  function TcpClient_dispose_closure(this_0) {
    this.this_0 = this_0;
  }
  TcpClient_dispose_closure.builtin$cls = "TcpClient_dispose_closure";
  if (!"name" in TcpClient_dispose_closure)
    TcpClient_dispose_closure.name = "TcpClient_dispose_closure";
  $desc = $collectedClasses.TcpClient_dispose_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TcpClient_dispose_closure.prototype = $desc;
