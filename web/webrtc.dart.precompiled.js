...
function dart_precompiled($collectedClasses) {
  ...
  Messenger.builtin$cls = "Messenger";
  if (!"name" in Messenger)
    Messenger.name = "Messenger";
  $desc = $collectedClasses.Messenger;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Messenger.prototype = $desc;
  return [JS_CONST, Interceptor, JSBool, JSNull, JSNumber, JSInt, JSDouble, JSString, Error, NullThrownError, ArgumentError, RangeError, CyclicInitializationError, Null, Object, StringBuffer, Messenger];
}
